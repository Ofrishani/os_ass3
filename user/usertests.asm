...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	efa50513          	addi	a0,a0,-262 # 5f38 <malloc+0x41a>
      46:	00006097          	auipc	ra,0x6
      4a:	a1a080e7          	jalr	-1510(ra) # 5a60 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	ed850513          	addi	a0,a0,-296 # 5f58 <malloc+0x43a>
      88:	00006097          	auipc	ra,0x6
      8c:	9d8080e7          	jalr	-1576(ra) # 5a60 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	ec850513          	addi	a0,a0,-312 # 5f70 <malloc+0x452>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	eca50513          	addi	a0,a0,-310 # 5f90 <malloc+0x472>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	e9250513          	addi	a0,a0,-366 # 5f78 <malloc+0x45a>
      ee:	00006097          	auipc	ra,0x6
      f2:	972080e7          	jalr	-1678(ra) # 5a60 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	e9e50513          	addi	a0,a0,-354 # 5fa0 <malloc+0x482>
     10a:	00006097          	auipc	ra,0x6
     10e:	956080e7          	jalr	-1706(ra) # 5a60 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	e9c50513          	addi	a0,a0,-356 # 5fc8 <malloc+0x4aa>
     134:	00005097          	auipc	ra,0x5
     138:	5fc080e7          	jalr	1532(ra) # 5730 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	e8850513          	addi	a0,a0,-376 # 5fc8 <malloc+0x4aa>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	e8458593          	addi	a1,a1,-380 # 5fd8 <malloc+0x4ba>
     15c:	00005097          	auipc	ra,0x5
     160:	5a4080e7          	jalr	1444(ra) # 5700 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	e6050513          	addi	a0,a0,-416 # 5fc8 <malloc+0x4aa>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	e6458593          	addi	a1,a1,-412 # 5fe0 <malloc+0x4c2>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	e3450513          	addi	a0,a0,-460 # 5fc8 <malloc+0x4aa>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	e1e50513          	addi	a0,a0,-482 # 5fe8 <malloc+0x4ca>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	88e080e7          	jalr	-1906(ra) # 5a60 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	b5c50513          	addi	a0,a0,-1188 # 5dd8 <malloc+0x2ba>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	b48a8a93          	addi	s5,s5,-1208 # 5dd8 <malloc+0x2ba>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	cfe50513          	addi	a0,a0,-770 # 6010 <malloc+0x4f2>
     31a:	00005097          	auipc	ra,0x5
     31e:	746080e7          	jalr	1862(ra) # 5a60 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     33a:	cfa50513          	addi	a0,a0,-774 # 6030 <malloc+0x512>
     33e:	00005097          	auipc	ra,0x5
     342:	722080e7          	jalr	1826(ra) # 5a60 <printf>
        exit(1);
     346:	4505                	li	a0,1
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	cd6a0a13          	addi	s4,s4,-810 # 6048 <malloc+0x52a>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	c3250513          	addi	a0,a0,-974 # 6050 <malloc+0x532>
     426:	00005097          	auipc	ra,0x5
     42a:	63a080e7          	jalr	1594(ra) # 5a60 <printf>
      exit(1);
     42e:	4505                	li	a0,1
     ...
     440:	c2c50513          	addi	a0,a0,-980 # 6068 <malloc+0x54a>
     444:	00005097          	auipc	ra,0x5
     448:	61c080e7          	jalr	1564(ra) # 5a60 <printf>
      exit(1);
     44c:	4505                	li	a0,1
     ...
     45e:	c3e50513          	addi	a0,a0,-962 # 6098 <malloc+0x57a>
     462:	00005097          	auipc	ra,0x5
     466:	5fe080e7          	jalr	1534(ra) # 5a60 <printf>
      exit(1);
     46a:	4505                	li	a0,1
     ...
     478:	c5450513          	addi	a0,a0,-940 # 60c8 <malloc+0x5aa>
     47c:	00005097          	auipc	ra,0x5
     480:	5e4080e7          	jalr	1508(ra) # 5a60 <printf>
      exit(1);
     484:	4505                	li	a0,1
     ...
     496:	c4650513          	addi	a0,a0,-954 # 60d8 <malloc+0x5ba>
     49a:	00005097          	auipc	ra,0x5
     49e:	5c6080e7          	jalr	1478(ra) # 5a60 <printf>
      exit(1);
     4a2:	4505                	li	a0,1
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	c38a0a13          	addi	s4,s4,-968 # 6108 <malloc+0x5ea>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	b08a8a93          	addi	s5,s5,-1272 # 5fe0 <malloc+0x4c2>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	b9250513          	addi	a0,a0,-1134 # 6110 <malloc+0x5f2>
     586:	00005097          	auipc	ra,0x5
     58a:	4da080e7          	jalr	1242(ra) # 5a60 <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     5a0:	b8c50513          	addi	a0,a0,-1140 # 6128 <malloc+0x60a>
     5a4:	00005097          	auipc	ra,0x5
     5a8:	4bc080e7          	jalr	1212(ra) # 5a60 <printf>
      exit(1);
     5ac:	4505                	li	a0,1
     ...
     5ba:	b1250513          	addi	a0,a0,-1262 # 60c8 <malloc+0x5aa>
     5be:	00005097          	auipc	ra,0x5
     5c2:	4a2080e7          	jalr	1186(ra) # 5a60 <printf>
      exit(1);
     5c6:	4505                	li	a0,1
     ...
     5d4:	b8850513          	addi	a0,a0,-1144 # 6158 <malloc+0x63a>
     5d8:	00005097          	auipc	ra,0x5
     5dc:	488080e7          	jalr	1160(ra) # 5a60 <printf>
      exit(1);
     5e0:	4505                	li	a0,1
     ...
     5f2:	b8250513          	addi	a0,a0,-1150 # 6170 <malloc+0x652>
     5f6:	00005097          	auipc	ra,0x5
     5fa:	46a080e7          	jalr	1130(ra) # 5a60 <printf>
      exit(1);
     5fe:	4505                	li	a0,1
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	99458593          	addi	a1,a1,-1644 # 5fd8 <malloc+0x4ba>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	96850513          	addi	a0,a0,-1688 # 5fc8 <malloc+0x4aa>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	93c50513          	addi	a0,a0,-1732 # 5fc8 <malloc+0x4aa>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	92850513          	addi	a0,a0,-1752 # 5fc8 <malloc+0x4aa>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	b2258593          	addi	a1,a1,-1246 # 6200 <malloc+0x6e2>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	8a850513          	addi	a0,a0,-1880 # 5fc8 <malloc+0x4aa>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	a3c50513          	addi	a0,a0,-1476 # 61a0 <malloc+0x682>
     76c:	00005097          	auipc	ra,0x5
     770:	2f4080e7          	jalr	756(ra) # 5a60 <printf>
    exit(1);
     774:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	a4050513          	addi	a0,a0,-1472 # 61c0 <malloc+0x6a2>
     788:	00005097          	auipc	ra,0x5
     78c:	2d8080e7          	jalr	728(ra) # 5a60 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     790:	8652                	mv	a2,s4
     792:	85d6                	mv	a1,s5
     794:	00006517          	auipc	a0,0x6
     798:	a3c50513          	addi	a0,a0,-1476 # 61d0 <malloc+0x6b2>
     79c:	00005097          	auipc	ra,0x5
     7a0:	2c4080e7          	jalr	708(ra) # 5a60 <printf>
    exit(1);
     7a4:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	a4050513          	addi	a0,a0,-1472 # 61f0 <malloc+0x6d2>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	2a8080e7          	jalr	680(ra) # 5a60 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7c0:	8652                	mv	a2,s4
     7c2:	85d6                	mv	a1,s5
     7c4:	00006517          	auipc	a0,0x6
     7c8:	a0c50513          	addi	a0,a0,-1524 # 61d0 <malloc+0x6b2>
     7cc:	00005097          	auipc	ra,0x5
     7d0:	294080e7          	jalr	660(ra) # 5a60 <printf>
    exit(1);
     7d4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	a2650513          	addi	a0,a0,-1498 # 6208 <malloc+0x6ea>
     7ea:	00005097          	auipc	ra,0x5
     7ee:	276080e7          	jalr	630(ra) # 5a60 <printf>
    exit(1);
     7f2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	a2850513          	addi	a0,a0,-1496 # 6228 <malloc+0x70a>
     808:	00005097          	auipc	ra,0x5
     80c:	258080e7          	jalr	600(ra) # 5a60 <printf>
    exit(1);
     810:	4505                	li	a0,1
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	a1450513          	addi	a0,a0,-1516 # 6248 <malloc+0x72a>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	a2498993          	addi	s3,s3,-1500 # 6270 <malloc+0x752>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	a54a8a93          	addi	s5,s5,-1452 # 62a8 <malloc+0x78a>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	9ae50513          	addi	a0,a0,-1618 # 6248 <malloc+0x72a>
  ...
  if(unlink("small") < 0){
     ...
     8da:	97250513          	addi	a0,a0,-1678 # 6248 <malloc+0x72a>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	95050513          	addi	a0,a0,-1712 # 6250 <malloc+0x732>
     908:	00005097          	auipc	ra,0x5
     90c:	158080e7          	jalr	344(ra) # 5a60 <printf>
    exit(1);
     910:	4505                	li	a0,1
     ...
     922:	96250513          	addi	a0,a0,-1694 # 6280 <malloc+0x762>
     926:	00005097          	auipc	ra,0x5
     92a:	13a080e7          	jalr	314(ra) # 5a60 <printf>
      exit(1);
     92e:	4505                	li	a0,1
     ...
     940:	97c50513          	addi	a0,a0,-1668 # 62b8 <malloc+0x79a>
     944:	00005097          	auipc	ra,0x5
     948:	11c080e7          	jalr	284(ra) # 5a60 <printf>
      exit(1);
     94c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	98850513          	addi	a0,a0,-1656 # 62e0 <malloc+0x7c2>
     960:	00005097          	auipc	ra,0x5
     964:	100080e7          	jalr	256(ra) # 5a60 <printf>
    exit(1);
     968:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     978:	98c50513          	addi	a0,a0,-1652 # 6300 <malloc+0x7e2>
     97c:	00005097          	auipc	ra,0x5
     980:	0e4080e7          	jalr	228(ra) # 5a60 <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	98850513          	addi	a0,a0,-1656 # 6318 <malloc+0x7fa>
     998:	00005097          	auipc	ra,0x5
     99c:	0c8080e7          	jalr	200(ra) # 5a60 <printf>
    exit(1);
     9a0:	4505                	li	a0,1
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	97650513          	addi	a0,a0,-1674 # 6338 <malloc+0x81a>
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	92450513          	addi	a0,a0,-1756 # 6338 <malloc+0x81a>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	8e450513          	addi	a0,a0,-1820 # 6340 <malloc+0x822>
     a64:	00005097          	auipc	ra,0x5
     a68:	ffc080e7          	jalr	-4(ra) # 5a60 <printf>
    exit(1);
     a6c:	4505                	li	a0,1
     ...
     a7e:	8e650513          	addi	a0,a0,-1818 # 6360 <malloc+0x842>
     a82:	00005097          	auipc	ra,0x5
     a86:	fde080e7          	jalr	-34(ra) # 5a60 <printf>
      exit(1);
     a8a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	8f250513          	addi	a0,a0,-1806 # 6388 <malloc+0x86a>
     a9e:	00005097          	auipc	ra,0x5
     aa2:	fc2080e7          	jalr	-62(ra) # 5a60 <printf>
    exit(1);
     aa6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac6:	87650513          	addi	a0,a0,-1930 # 6338 <malloc+0x81a>
     ...
     af2:	8ba50513          	addi	a0,a0,-1862 # 63a8 <malloc+0x88a>
     af6:	00005097          	auipc	ra,0x5
     afa:	f6a080e7          	jalr	-150(ra) # 5a60 <printf>
        exit(1);
     afe:	4505                	li	a0,1
     ...
     b10:	8c450513          	addi	a0,a0,-1852 # 63d0 <malloc+0x8b2>
     b14:	00005097          	auipc	ra,0x5
     b18:	f4c080e7          	jalr	-180(ra) # 5a60 <printf>
      exit(1);
     b1c:	4505                	li	a0,1
     ...
     b2e:	8be50513          	addi	a0,a0,-1858 # 63e8 <malloc+0x8ca>
     b32:	00005097          	auipc	ra,0x5
     b36:	f2e080e7          	jalr	-210(ra) # 5a60 <printf>
      exit(1);
     b3a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	8ca50513          	addi	a0,a0,-1846 # 6410 <malloc+0x8f2>
     b4e:	00005097          	auipc	ra,0x5
     b52:	f12080e7          	jalr	-238(ra) # 5a60 <printf>
    exit(1);
     b56:	4505                	li	a0,1
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	1f450513          	addi	a0,a0,500 # 5d68 <malloc+0x24a>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	8bc58593          	addi	a1,a1,-1860 # 6448 <malloc+0x92a>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	1c050513          	addi	a0,a0,448 # 5d68 <malloc+0x24a>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	1aa50513          	addi	a0,a0,426 # 5d68 <malloc+0x24a>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	19450513          	addi	a0,a0,404 # 5d68 <malloc+0x24a>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	8a858593          	addi	a1,a1,-1880 # 6490 <malloc+0x972>
  ...
  unlink("unlinkread");
     ...
     c54:	11850513          	addi	a0,a0,280 # 5d68 <malloc+0x24a>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	7b850513          	addi	a0,a0,1976 # 6428 <malloc+0x90a>
     c78:	00005097          	auipc	ra,0x5
     c7c:	de8080e7          	jalr	-536(ra) # 5a60 <printf>
    exit(1);
     c80:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	7c450513          	addi	a0,a0,1988 # 6450 <malloc+0x932>
     c94:	00005097          	auipc	ra,0x5
     c98:	dcc080e7          	jalr	-564(ra) # 5a60 <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	7c850513          	addi	a0,a0,1992 # 6470 <malloc+0x952>
     cb0:	00005097          	auipc	ra,0x5
     cb4:	db0080e7          	jalr	-592(ra) # 5a60 <printf>
    exit(1);
     cb8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	7d450513          	addi	a0,a0,2004 # 6498 <malloc+0x97a>
     ccc:	00005097          	auipc	ra,0x5
     cd0:	d94080e7          	jalr	-620(ra) # 5a60 <printf>
    exit(1);
     cd4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	7d850513          	addi	a0,a0,2008 # 64b8 <malloc+0x99a>
     ce8:	00005097          	auipc	ra,0x5
     cec:	d78080e7          	jalr	-648(ra) # 5a60 <printf>
    exit(1);
     cf0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	7dc50513          	addi	a0,a0,2012 # 64d8 <malloc+0x9ba>
     d04:	00005097          	auipc	ra,0x5
     d08:	d5c080e7          	jalr	-676(ra) # 5a60 <printf>
    exit(1);
     d0c:	4505                	li	a0,1
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	6e858593          	addi	a1,a1,1768 # 6448 <malloc+0x92a>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	78058593          	addi	a1,a1,1920 # 6500 <malloc+0x9e2>
     d88:	00005517          	auipc	a0,0x5
     d8c:	77050513          	addi	a0,a0,1904 # 64f8 <malloc+0x9da>
  ...
  unlink("lf1");
     ...
     da0:	75c50513          	addi	a0,a0,1884 # 64f8 <malloc+0x9da>
     da4:	00005097          	auipc	ra,0x5
     da8:	98c080e7          	jalr	-1652(ra) # 5730 <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00005517          	auipc	a0,0x5
     db2:	74a50513          	addi	a0,a0,1866 # 64f8 <malloc+0x9da>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	73c50513          	addi	a0,a0,1852 # 6500 <malloc+0x9e2>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	70458593          	addi	a1,a1,1796 # 6500 <malloc+0x9e2>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	6ee50513          	addi	a0,a0,1774 # 6500 <malloc+0x9e2>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	916080e7          	jalr	-1770(ra) # 5730 <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00005597          	auipc	a1,0x5
     e26:	6d658593          	addi	a1,a1,1750 # 64f8 <malloc+0x9da>
     e2a:	00005517          	auipc	a0,0x5
     e2e:	6d650513          	addi	a0,a0,1750 # 6500 <malloc+0x9e2>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	6ba58593          	addi	a1,a1,1722 # 64f8 <malloc+0x9da>
     e46:	00005517          	auipc	a0,0x5
     e4a:	7c250513          	addi	a0,a0,1986 # 6608 <malloc+0xaea>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	6a050513          	addi	a0,a0,1696 # 6508 <malloc+0x9ea>
     e70:	00005097          	auipc	ra,0x5
     e74:	bf0080e7          	jalr	-1040(ra) # 5a60 <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	69c50513          	addi	a0,a0,1692 # 6520 <malloc+0xa02>
     e8c:	00005097          	auipc	ra,0x5
     e90:	bd4080e7          	jalr	-1068(ra) # 5a60 <printf>
    exit(1);
     e94:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	69850513          	addi	a0,a0,1688 # 6538 <malloc+0xa1a>
     ea8:	00005097          	auipc	ra,0x5
     eac:	bb8080e7          	jalr	-1096(ra) # 5a60 <printf>
    exit(1);
     eb0:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	69c50513          	addi	a0,a0,1692 # 6558 <malloc+0xa3a>
     ec4:	00005097          	auipc	ra,0x5
     ec8:	b9c080e7          	jalr	-1124(ra) # 5a60 <printf>
    exit(1);
     ecc:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	6b050513          	addi	a0,a0,1712 # 6588 <malloc+0xa6a>
     ee0:	00005097          	auipc	ra,0x5
     ee4:	b80080e7          	jalr	-1152(ra) # 5a60 <printf>
    exit(1);
     ee8:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	6ac50513          	addi	a0,a0,1708 # 65a0 <malloc+0xa82>
     efc:	00005097          	auipc	ra,0x5
     f00:	b64080e7          	jalr	-1180(ra) # 5a60 <printf>
    exit(1);
     f04:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	6a850513          	addi	a0,a0,1704 # 65b8 <malloc+0xa9a>
     f18:	00005097          	auipc	ra,0x5
     f1c:	b48080e7          	jalr	-1208(ra) # 5a60 <printf>
    exit(1);
     f20:	4505                	li	a0,1
    ...
    printf("%s: link non-existant succeeded! oops\n", s);
     ...
     f30:	6b450513          	addi	a0,a0,1716 # 65e0 <malloc+0xac2>
     f34:	00005097          	auipc	ra,0x5
     f38:	b2c080e7          	jalr	-1236(ra) # 5a60 <printf>
    exit(1);
     f3c:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	6c850513          	addi	a0,a0,1736 # 6610 <malloc+0xaf2>
     f50:	00005097          	auipc	ra,0x5
     f54:	b10080e7          	jalr	-1264(ra) # 5a60 <printf>
    exit(1);
     f58:	4505                	li	a0,1
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	682a0a13          	addi	s4,s4,1666 # 6630 <malloc+0xb12>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	63050513          	addi	a0,a0,1584 # 6630 <malloc+0xb12>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	5c850513          	addi	a0,a0,1480 # 6638 <malloc+0xb1a>
    1078:	00005097          	auipc	ra,0x5
    107c:	9e8080e7          	jalr	-1560(ra) # 5a60 <printf>
    exit(1);
    1080:	4505                	li	a0,1
    ...
    1094:	5c850513          	addi	a0,a0,1480 # 6658 <malloc+0xb3a>
    1098:	00005097          	auipc	ra,0x5
    109c:	9c8080e7          	jalr	-1592(ra) # 5a60 <printf>
      exit(1);
    10a0:	4505                	li	a0,1
    ...
    10b0:	5cc50513          	addi	a0,a0,1484 # 6678 <malloc+0xb5a>
    10b4:	00005097          	auipc	ra,0x5
    10b8:	9ac080e7          	jalr	-1620(ra) # 5a60 <printf>
      exit(1);
    10bc:	4505                	li	a0,1
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	5ba98993          	addi	s3,s3,1466 # 6698 <malloc+0xb7a>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	58e50513          	addi	a0,a0,1422 # 66a8 <malloc+0xb8a>
    1122:	00005097          	auipc	ra,0x5
    1126:	93e080e7          	jalr	-1730(ra) # 5a60 <printf>
      exit(1);
    112a:	4505                	li	a0,1
...
badarg(char *s)
{
  ...
  for(int i = 0; i < 50000; i++){
    ...
    118a:	dea98993          	addi	s3,s3,-534 # 5f70 <malloc+0x452>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	66878793          	addi	a5,a5,1640 # 7878 <malloc+0x1d5a>
  ...
  if(pid == 0){
    ...
    1270:	d3c78793          	addi	a5,a5,-708 # 7fa8 <malloc+0x248a>
    ...
    1294:	ce050513          	addi	a0,a0,-800 # 5f70 <malloc+0x452>
    ...
    12ac:	4a850513          	addi	a0,a0,1192 # 6750 <malloc+0xc32>
    12b0:	00004097          	auipc	ra,0x4
    12b4:	7b0080e7          	jalr	1968(ra) # 5a60 <printf>
      exit(1);
    12b8:	4505                	li	a0,1
    ...
    12cc:	40050513          	addi	a0,a0,1024 # 66c8 <malloc+0xbaa>
    12d0:	00004097          	auipc	ra,0x4
    12d4:	790080e7          	jalr	1936(ra) # 5a60 <printf>
    exit(1);
    12d8:	4505                	li	a0,1
    ...
    12ec:	40050513          	addi	a0,a0,1024 # 66e8 <malloc+0xbca>
    12f0:	00004097          	auipc	ra,0x4
    12f4:	770080e7          	jalr	1904(ra) # 5a60 <printf>
    exit(1);
    12f8:	4505                	li	a0,1
    ...
    130e:	3fe50513          	addi	a0,a0,1022 # 6708 <malloc+0xbea>
    1312:	00004097          	auipc	ra,0x4
    1316:	74e080e7          	jalr	1870(ra) # 5a60 <printf>
    exit(1);
    131a:	4505                	li	a0,1
    ...
    132e:	40650513          	addi	a0,a0,1030 # 6730 <malloc+0xc12>
    1332:	00004097          	auipc	ra,0x4
    1336:	72e080e7          	jalr	1838(ra) # 5a60 <printf>
    exit(1);
    133a:	4505                	li	a0,1
    ...
    1348:	86c50513          	addi	a0,a0,-1940 # 6bb0 <malloc+0x1092>
    134c:	00004097          	auipc	ra,0x4
    1350:	714080e7          	jalr	1812(ra) # 5a60 <printf>
    exit(1);
    1354:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1392:	3ea50513          	addi	a0,a0,1002 # 6778 <malloc+0xc5a>
    1396:	00004097          	auipc	ra,0x4
    139a:	6ca080e7          	jalr	1738(ra) # 5a60 <printf>
    exit(1);
    139e:	4505                	li	a0,1
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	c0850513          	addi	a0,a0,-1016 # 5fc8 <malloc+0x4aa>
  ...
  if(pid == 0){
    ...
    13ee:	bdea0a13          	addi	s4,s4,-1058 # 5fc8 <malloc+0x4aa>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	3e6a8a93          	addi	s5,s5,998 # 67d8 <malloc+0xcba>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	34650513          	addi	a0,a0,838 # 67a8 <malloc+0xc8a>
    146a:	00004097          	auipc	ra,0x4
    146e:	5f6080e7          	jalr	1526(ra) # 5a60 <printf>
    exit(1);
    1472:	4505                	li	a0,1
    ...
    1482:	34250513          	addi	a0,a0,834 # 67c0 <malloc+0xca2>
    1486:	00004097          	auipc	ra,0x4
    148a:	5da080e7          	jalr	1498(ra) # 5a60 <printf>
        exit(1);
    148e:	4505                	li	a0,1
    ...
    14a0:	34c50513          	addi	a0,a0,844 # 67e8 <malloc+0xcca>
    14a4:	00004097          	auipc	ra,0x4
    14a8:	5bc080e7          	jalr	1468(ra) # 5a60 <printf>
        exit(1);
    14ac:	4505                	li	a0,1
    ...
    14be:	b0ea0a13          	addi	s4,s4,-1266 # 5fc8 <malloc+0x4aa>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	346a8a93          	addi	s5,s5,838 # 6808 <malloc+0xcea>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	abc50513          	addi	a0,a0,-1348 # 5fc8 <malloc+0x4aa>
  ...
  exit(xstatus);
    ...
    152e:	29650513          	addi	a0,a0,662 # 67c0 <malloc+0xca2>
    1532:	00004097          	auipc	ra,0x4
    1536:	52e080e7          	jalr	1326(ra) # 5a60 <printf>
      exit(1);
    153a:	4505                	li	a0,1
    ...
    154c:	2c850513          	addi	a0,a0,712 # 6810 <malloc+0xcf2>
    1550:	00004097          	auipc	ra,0x4
    1554:	510080e7          	jalr	1296(ra) # 5a60 <printf>
      exit(1);
    1558:	4505                	li	a0,1
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	a0078793          	addi	a5,a5,-1536 # 5f70 <malloc+0x452>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	2b478793          	addi	a5,a5,692 # 6830 <malloc+0xd12>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	2ac50513          	addi	a0,a0,684 # 6838 <malloc+0xd1a>
  ...
  if(pid == 0) {
    ...
    15be:	27e50513          	addi	a0,a0,638 # 6838 <malloc+0xd1a>
    ...
    15da:	28250513          	addi	a0,a0,642 # 6858 <malloc+0xd3a>
    15de:	00004097          	auipc	ra,0x4
    15e2:	482080e7          	jalr	1154(ra) # 5a60 <printf>
      exit(1);
    15e6:	4505                	li	a0,1
    ...
    15f6:	1b650513          	addi	a0,a0,438 # 67a8 <malloc+0xc8a>
    15fa:	00004097          	auipc	ra,0x4
    15fe:	466080e7          	jalr	1126(ra) # 5a60 <printf>
     exit(1);
    1602:	4505                	li	a0,1
    ...
    1612:	23250513          	addi	a0,a0,562 # 6840 <malloc+0xd22>
    1616:	00004097          	auipc	ra,0x4
    161a:	44a080e7          	jalr	1098(ra) # 5a60 <printf>
      exit(1);
    161e:	4505                	li	a0,1
    ...
    1630:	94450513          	addi	a0,a0,-1724 # 5f70 <malloc+0x452>
  ...
  if(xstatus != 0)
    ...
    1664:	20850513          	addi	a0,a0,520 # 6868 <malloc+0xd4a>
    1668:	00004097          	auipc	ra,0x4
    166c:	3f8080e7          	jalr	1016(ra) # 5a60 <printf>
      exit(1);
    1670:	4505                	li	a0,1
    ...
    1680:	20450513          	addi	a0,a0,516 # 6880 <malloc+0xd62>
    1684:	00004097          	auipc	ra,0x4
    1688:	3dc080e7          	jalr	988(ra) # 5a60 <printf>
    168c:	b7d1                	j	1650 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168e:	4581                	li	a1,0
    1690:	00005517          	auipc	a0,0x5
    1694:	1a850513          	addi	a0,a0,424 # 6838 <malloc+0xd1a>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	c4650513          	addi	a0,a0,-954 # 6300 <malloc+0x7e2>
    16c2:	00004097          	auipc	ra,0x4
    16c6:	39e080e7          	jalr	926(ra) # 5a60 <printf>
    exit(1);
    16ca:	4505                	li	a0,1
    ...
    16da:	0ea50513          	addi	a0,a0,234 # 67c0 <malloc+0xca2>
    16de:	00004097          	auipc	ra,0x4
    16e2:	382080e7          	jalr	898(ra) # 5a60 <printf>
    exit(1);
    16e6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f4:	14850513          	addi	a0,a0,328 # 6838 <malloc+0xd1a>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	17e50513          	addi	a0,a0,382 # 6898 <malloc+0xd7a>
    1722:	00004097          	auipc	ra,0x4
    1726:	33e080e7          	jalr	830(ra) # 5a60 <printf>
    exit(1);
    172a:	4505                	li	a0,1
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17e0:	0d450513          	addi	a0,a0,212 # 68b0 <malloc+0xd92>
    17e4:	00004097          	auipc	ra,0x4
    17e8:	27c080e7          	jalr	636(ra) # 5a60 <printf>
    exit(1);
    17ec:	4505                	li	a0,1
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	06650513          	addi	a0,a0,102 # 68c8 <malloc+0xdaa>
    186a:	00004097          	auipc	ra,0x4
    186e:	1f6080e7          	jalr	502(ra) # 5a60 <printf>
        exit(1);
    1872:	4505                	li	a0,1
    ...
    1882:	06250513          	addi	a0,a0,98 # 68e0 <malloc+0xdc2>
    1886:	00004097          	auipc	ra,0x4
    188a:	1da080e7          	jalr	474(ra) # 5a60 <printf>
}
    ...
    18b4:	04850513          	addi	a0,a0,72 # 68f8 <malloc+0xdda>
    18b8:	00004097          	auipc	ra,0x4
    18bc:	1a8080e7          	jalr	424(ra) # 5a60 <printf>
      exit(1);
    18c0:	4505                	li	a0,1
    ...
    18f4:	02850513          	addi	a0,a0,40 # 6918 <malloc+0xdfa>
    18f8:	00004097          	auipc	ra,0x4
    18fc:	168080e7          	jalr	360(ra) # 5a60 <printf>
    exit(1);
    1900:	4505                	li	a0,1
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	e4650513          	addi	a0,a0,-442 # 67a8 <malloc+0xc8a>
    196a:	00004097          	auipc	ra,0x4
    196e:	0f6080e7          	jalr	246(ra) # 5a60 <printf>
      exit(1);
    1972:	4505                	li	a0,1
    ...
    1982:	fb250513          	addi	a0,a0,-78 # 6930 <malloc+0xe12>
    1986:	00004097          	auipc	ra,0x4
    198a:	0da080e7          	jalr	218(ra) # 5a60 <printf>
        exit(1);
    198e:	4505                	li	a0,1
    ...
    199e:	fae50513          	addi	a0,a0,-82 # 6948 <malloc+0xe2a>
    19a2:	00004097          	auipc	ra,0x4
    19a6:	0be080e7          	jalr	190(ra) # 5a60 <printf>
        exit(1);
    19aa:	4505                	li	a0,1
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	d9650513          	addi	a0,a0,-618 # 67a8 <malloc+0xc8a>
    1a1a:	00004097          	auipc	ra,0x4
    1a1e:	046080e7          	jalr	70(ra) # 5a60 <printf>
      exit(1);
    1a22:	4505                	li	a0,1
    ...
    1a3a:	d7250513          	addi	a0,a0,-654 # 67a8 <malloc+0xc8a>
    1a3e:	00004097          	auipc	ra,0x4
    1a42:	022080e7          	jalr	34(ra) # 5a60 <printf>
        exit(1);
    1a46:	4505                	li	a0,1
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	eb850513          	addi	a0,a0,-328 # 6968 <malloc+0xe4a>
    1ab8:	00004097          	auipc	ra,0x4
    1abc:	fa8080e7          	jalr	-88(ra) # 5a60 <printf>
      exit(1);
    1ac0:	4505                	li	a0,1
    ...
    1ac6:	c1e080e7          	jalr	-994(ra) # 56e0 <exit>
{
    ...
    1b0c:	e7050513          	addi	a0,a0,-400 # 6978 <malloc+0xe5a>
    1b10:	00004097          	auipc	ra,0x4
    1b14:	f50080e7          	jalr	-176(ra) # 5a60 <printf>
      exit(1);
    1b18:	4505                	li	a0,1
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	05a50513          	addi	a0,a0,90 # 6bb0 <malloc+0x1092>
    1b5e:	00004097          	auipc	ra,0x4
    1b62:	f02080e7          	jalr	-254(ra) # 5a60 <printf>
      exit(1);
    1b66:	4505                	li	a0,1
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	fbc50513          	addi	a0,a0,-68 # 6bb0 <malloc+0x1092>
    1bfc:	00004097          	auipc	ra,0x4
    1c00:	e64080e7          	jalr	-412(ra) # 5a60 <printf>
      exit(1);
    1c04:	4505                	li	a0,1
    ...
    1c24:	c2050513          	addi	a0,a0,-992 # 6840 <malloc+0xd22>
    1c28:	00004097          	auipc	ra,0x4
    1c2c:	e38080e7          	jalr	-456(ra) # 5a60 <printf>
          exit(1);
    1c30:	4505                	li	a0,1
    ...
    1c96:	d0650513          	addi	a0,a0,-762 # 6998 <malloc+0xe7a>
    1c9a:	00004097          	auipc	ra,0x4
    1c9e:	dc6080e7          	jalr	-570(ra) # 5a60 <printf>
            exit(1);
    1ca2:	4505                	li	a0,1
    ...
    1cca:	cea50513          	addi	a0,a0,-790 # 69b0 <malloc+0xe92>
    1cce:	00004097          	auipc	ra,0x4
    1cd2:	d92080e7          	jalr	-622(ra) # 5a60 <printf>
        exit(1);
    1cd6:	4505                	li	a0,1
    ...
    1d30:	cac50513          	addi	a0,a0,-852 # 69d8 <malloc+0xeba>
    1d34:	00004097          	auipc	ra,0x4
    1d38:	d2c080e7          	jalr	-724(ra) # 5a60 <printf>
        exit(1);
    1d3c:	4505                	li	a0,1
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	21450513          	addi	a0,a0,532 # 5fe0 <malloc+0x4c2>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0c:	1d8a8a93          	addi	s5,s5,472 # 5fe0 <malloc+0x4c2>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	bf0b8b93          	addi	s7,s7,-1040 # 6a00 <malloc+0xee2>
    1e18:	a825                	j	1e50 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	98c50513          	addi	a0,a0,-1652 # 67a8 <malloc+0xc8a>
    1e24:	00004097          	auipc	ra,0x4
    1e28:	c3c080e7          	jalr	-964(ra) # 5a60 <printf>
    exit(1);
    1e2c:	4505                	li	a0,1
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	ca650513          	addi	a0,a0,-858 # 6bb0 <malloc+0x1092>
    1f12:	00004097          	auipc	ra,0x4
    1f16:	b4e080e7          	jalr	-1202(ra) # 5a60 <printf>
      exit(1);
    1f1a:	4505                	li	a0,1
    ...
    1fbe:	a4e50513          	addi	a0,a0,-1458 # 6a08 <malloc+0xeea>
    1fc2:	00004097          	auipc	ra,0x4
    1fc6:	a9e080e7          	jalr	-1378(ra) # 5a60 <printf>
            exit(1);
    1fca:	4505                	li	a0,1
    ...
    1fde:	05650513          	addi	a0,a0,86 # 6030 <malloc+0x512>
    1fe2:	00004097          	auipc	ra,0x4
    1fe6:	a7e080e7          	jalr	-1410(ra) # 5a60 <printf>
            exit(1);
    1fea:	4505                	li	a0,1
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	a1050513          	addi	a0,a0,-1520 # 6a38 <malloc+0xf1a>
    2030:	00004097          	auipc	ra,0x4
    2034:	a30080e7          	jalr	-1488(ra) # 5a60 <printf>
    exit(1);
    2038:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208e:	99650513          	addi	a0,a0,-1642 # 6a20 <malloc+0xf02>
    2092:	00004097          	auipc	ra,0x4
    2096:	9ce080e7          	jalr	-1586(ra) # 5a60 <printf>
    exit(1);
    209a:	4505                	li	a0,1
    ...
    20aa:	9ba50513          	addi	a0,a0,-1606 # 6a60 <malloc+0xf42>
    20ae:	00004097          	auipc	ra,0x4
    20b2:	9b2080e7          	jalr	-1614(ra) # 5a60 <printf>
      exit(1);
    20b6:	4505                	li	a0,1
    ...
    20c6:	9b650513          	addi	a0,a0,-1610 # 6a78 <malloc+0xf5a>
    20ca:	00004097          	auipc	ra,0x4
    20ce:	996080e7          	jalr	-1642(ra) # 5a60 <printf>
    exit(1);
    20d2:	4505                	li	a0,1
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	66650513          	addi	a0,a0,1638 # 67a8 <malloc+0xc8a>
    214a:	00004097          	auipc	ra,0x4
    214e:	916080e7          	jalr	-1770(ra) # 5a60 <printf>
      exit(1);
    2152:	4505                	li	a0,1
    ...
    2168:	92c50513          	addi	a0,a0,-1748 # 6a90 <malloc+0xf72>
    216c:	00004097          	auipc	ra,0x4
    2170:	8f4080e7          	jalr	-1804(ra) # 5a60 <printf>
      exit(1);
    2174:	4505                	li	a0,1
...
0000000000002188 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2198:	91c50513          	addi	a0,a0,-1764 # 6ab0 <malloc+0xf92>
  ...
  fd = open("bigarg-ok", 0);
    ...
    21ca:	8ea50513          	addi	a0,a0,-1814 # 6ab0 <malloc+0xf92>
  ...
  close(fd);
    ...
    2200:	8c470713          	addi	a4,a4,-1852 # 6ac0 <malloc+0xfa2>
    ...
    2254:	95050513          	addi	a0,a0,-1712 # 6ba0 <malloc+0x1082>
    2258:	00004097          	auipc	ra,0x4
    225c:	808080e7          	jalr	-2040(ra) # 5a60 <printf>
    exit(1);
    2260:	4505                	li	a0,1
    ...
    2278:	94c50513          	addi	a0,a0,-1716 # 6bc0 <malloc+0x10a2>
    227c:	00003097          	auipc	ra,0x3
    2280:	7e4080e7          	jalr	2020(ra) # 5a60 <printf>
    exit(1);
    2284:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    22d6:	90e50513          	addi	a0,a0,-1778 # 6be0 <malloc+0x10c2>
    22da:	00003097          	auipc	ra,0x3
    22de:	786080e7          	jalr	1926(ra) # 5a60 <printf>
    exit(1);
    22e2:	4505                	li	a0,1
    ...
    22f2:	4ba50513          	addi	a0,a0,1210 # 67a8 <malloc+0xc8a>
    22f6:	00003097          	auipc	ra,0x3
    22fa:	76a080e7          	jalr	1898(ra) # 5a60 <printf>
    exit(1);
    22fe:	4505                	li	a0,1
...
0000000000002312 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    238c:	4f078793          	addi	a5,a5,1264 # 7878 <malloc+0x1d5a>
  ...
  if(ret != -1){
    ...
    23ce:	83e50513          	addi	a0,a0,-1986 # 6c08 <malloc+0x10ea>
    23d2:	00003097          	auipc	ra,0x3
    23d6:	68e080e7          	jalr	1678(ra) # 5a60 <printf>
    exit(1);
    23da:	4505                	li	a0,1
    ...
    23ec:	2e050513          	addi	a0,a0,736 # 66c8 <malloc+0xbaa>
    23f0:	00003097          	auipc	ra,0x3
    23f4:	670080e7          	jalr	1648(ra) # 5a60 <printf>
    exit(1);
    23f8:	4505                	li	a0,1
    ...
    240a:	2e250513          	addi	a0,a0,738 # 66e8 <malloc+0xbca>
    240e:	00003097          	auipc	ra,0x3
    2412:	652080e7          	jalr	1618(ra) # 5a60 <printf>
    exit(1);
    2416:	4505                	li	a0,1
    ...
    242a:	2e250513          	addi	a0,a0,738 # 6708 <malloc+0xbea>
    242e:	00003097          	auipc	ra,0x3
    2432:	632080e7          	jalr	1586(ra) # 5a60 <printf>
    exit(1);
    2436:	4505                	li	a0,1
    ...
    2448:	2ec50513          	addi	a0,a0,748 # 6730 <malloc+0xc12>
    244c:	00003097          	auipc	ra,0x3
    2450:	614080e7          	jalr	1556(ra) # 5a60 <printf>
    exit(1);
    2454:	4505                	li	a0,1
...
000000000000245e <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2494:	7f050513          	addi	a0,a0,2032 # 5c80 <malloc+0x162>
  ...
  if(n >= 0){
    ...
    24c6:	79e50513          	addi	a0,a0,1950 # 6c60 <malloc+0x1142>
    24ca:	00003097          	auipc	ra,0x3
    24ce:	596080e7          	jalr	1430(ra) # 5a60 <printf>
    exit(1);
    24d2:	4505                	li	a0,1
    ...
    24e0:	73450513          	addi	a0,a0,1844 # 6c10 <malloc+0x10f2>
    24e4:	00003097          	auipc	ra,0x3
    24e8:	57c080e7          	jalr	1404(ra) # 5a60 <printf>
    exit(1);
    24ec:	4505                	li	a0,1
    ...
    24fa:	73250513          	addi	a0,a0,1842 # 6c28 <malloc+0x110a>
    24fe:	00003097          	auipc	ra,0x3
    2502:	562080e7          	jalr	1378(ra) # 5a60 <printf>
    exit(1);
    2506:	4505                	li	a0,1
    ...
    2514:	73850513          	addi	a0,a0,1848 # 6c48 <malloc+0x112a>
    2518:	00003097          	auipc	ra,0x3
    251c:	548080e7          	jalr	1352(ra) # 5a60 <printf>
    exit(1);
    2520:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2538:	74c50513          	addi	a0,a0,1868 # 5c80 <malloc+0x162>
    253c:	00003097          	auipc	ra,0x3
    2540:	1f4080e7          	jalr	500(ra) # 5730 <unlink>
  fd = open("README", O_RDONLY);
    2544:	4581                	li	a1,0
    2546:	00004517          	auipc	a0,0x4
    254a:	bc250513          	addi	a0,a0,-1086 # 6108 <malloc+0x5ea>
  ...
  if(n >= 0){
    ...
    2574:	72050513          	addi	a0,a0,1824 # 6c90 <malloc+0x1172>
    2578:	00003097          	auipc	ra,0x3
    257c:	4e8080e7          	jalr	1256(ra) # 5a60 <printf>
    exit(1);
    2580:	4505                	li	a0,1
    ...
    258e:	6be50513          	addi	a0,a0,1726 # 6c48 <malloc+0x112a>
    2592:	00003097          	auipc	ra,0x3
    2596:	4ce080e7          	jalr	1230(ra) # 5a60 <printf>
    exit(1);
    259a:	4505                	li	a0,1
...
00000000000025b8 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    260e:	6ae50513          	addi	a0,a0,1710 # 6cb8 <malloc+0x119a>
    2612:	00003097          	auipc	ra,0x3
    2616:	44e080e7          	jalr	1102(ra) # 5a60 <printf>
    exit(1);
    261a:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2660:	67c50513          	addi	a0,a0,1660 # 6cd8 <malloc+0x11ba>
    2664:	00003097          	auipc	ra,0x3
    2668:	3fc080e7          	jalr	1020(ra) # 5a60 <printf>
    exit(1);
    266c:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    26c4:	67850513          	addi	a0,a0,1656 # 6d38 <malloc+0x121a>
    26c8:	00003097          	auipc	ra,0x3
    26cc:	398080e7          	jalr	920(ra) # 5a60 <printf>
    exit(1);
    26d0:	4505                	li	a0,1
    ...
    26e4:	61850513          	addi	a0,a0,1560 # 6cf8 <malloc+0x11da>
    26e8:	00003097          	auipc	ra,0x3
    26ec:	378080e7          	jalr	888(ra) # 5a60 <printf>
      exit(1);
    26f0:	4505                	li	a0,1
    ...
    2700:	61c50513          	addi	a0,a0,1564 # 6d18 <malloc+0x11fa>
    2704:	00003097          	auipc	ra,0x3
    2708:	35c080e7          	jalr	860(ra) # 5a60 <printf>
    exit(1);
    270c:	4505                	li	a0,1
...
000000000000273c <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    284a:	51250513          	addi	a0,a0,1298 # 6d58 <malloc+0x123a>
    284e:	00003097          	auipc	ra,0x3
    2852:	212080e7          	jalr	530(ra) # 5a60 <printf>
    exit(1);
    2856:	4505                	li	a0,1
    ...
    2866:	53e50513          	addi	a0,a0,1342 # 6da0 <malloc+0x1282>
    286a:	00003097          	auipc	ra,0x3
    286e:	1f6080e7          	jalr	502(ra) # 5a60 <printf>
    exit(1);
    2872:	4505                	li	a0,1
    ...
    2886:	53e50513          	addi	a0,a0,1342 # 6dc0 <malloc+0x12a2>
    288a:	00003097          	auipc	ra,0x3
    288e:	1d6080e7          	jalr	470(ra) # 5a60 <printf>
    exit(1);
    2892:	4505                	li	a0,1
    ...
    28a6:	55e50513          	addi	a0,a0,1374 # 6e00 <malloc+0x12e2>
    28aa:	00003097          	auipc	ra,0x3
    28ae:	1b6080e7          	jalr	438(ra) # 5a60 <printf>
    exit(1);
    28b2:	4505                	li	a0,1
    ...
    28c2:	57250513          	addi	a0,a0,1394 # 6e30 <malloc+0x1312>
    28c6:	00003097          	auipc	ra,0x3
    28ca:	19a080e7          	jalr	410(ra) # 5a60 <printf>
    exit(1);
    28ce:	4505                	li	a0,1
    ...
    28e2:	58a50513          	addi	a0,a0,1418 # 6e68 <malloc+0x134a>
    28e6:	00003097          	auipc	ra,0x3
    28ea:	17a080e7          	jalr	378(ra) # 5a60 <printf>
    exit(1);
    28ee:	4505                	li	a0,1
...
00000000000028f8 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    291c:	57850513          	addi	a0,a0,1400 # 6e90 <malloc+0x1372>
    2920:	00003097          	auipc	ra,0x3
    2924:	e00080e7          	jalr	-512(ra) # 5720 <open>
    2928:	84aa                	mv	s1,a0
  unlink("sbrk");
    292a:	00004517          	auipc	a0,0x4
    292e:	56650513          	addi	a0,a0,1382 # 6e90 <malloc+0x1372>
  ...
  if(pipe((int *) a) != 0){
    ...
    2982:	51a50513          	addi	a0,a0,1306 # 6e98 <malloc+0x137a>
    2986:	00003097          	auipc	ra,0x3
    298a:	0da080e7          	jalr	218(ra) # 5a60 <printf>
    exit(1);
    298e:	4505                	li	a0,1
    ...
    299e:	51650513          	addi	a0,a0,1302 # 6eb0 <malloc+0x1392>
    29a2:	00003097          	auipc	ra,0x3
    29a6:	0be080e7          	jalr	190(ra) # 5a60 <printf>
    exit(1);
    29aa:	4505                	li	a0,1
    ...
    29ba:	efa50513          	addi	a0,a0,-262 # 68b0 <malloc+0xd92>
    29be:	00003097          	auipc	ra,0x3
    29c2:	0a2080e7          	jalr	162(ra) # 5a60 <printf>
    exit(1);
    29c6:	4505                	li	a0,1
...
00000000000029d0 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    29e4:	4e850513          	addi	a0,a0,1256 # 6ec8 <malloc+0x13aa>
  ...
  close(fd);
    ...
    2a2c:	d9850513          	addi	a0,a0,-616 # 67c0 <malloc+0xca2>
    2a30:	00003097          	auipc	ra,0x3
    2a34:	030080e7          	jalr	48(ra) # 5a60 <printf>
    exit(1);
    2a38:	4505                	li	a0,1
...
0000000000002a42 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2a7a:	13a50513          	addi	a0,a0,314 # 6bb0 <malloc+0x1092>
    2a7e:	00003097          	auipc	ra,0x3
    2a82:	fe2080e7          	jalr	-30(ra) # 5a60 <printf>
    exit(1);
    2a86:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2ad0:	0e450513          	addi	a0,a0,228 # 6bb0 <malloc+0x1092>
    2ad4:	00003097          	auipc	ra,0x3
    2ad8:	f8c080e7          	jalr	-116(ra) # 5a60 <printf>
    exit(1);
    2adc:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b30:	08450513          	addi	a0,a0,132 # 6bb0 <malloc+0x1092>
    2b34:	00003097          	auipc	ra,0x3
    2b38:	f2c080e7          	jalr	-212(ra) # 5a60 <printf>
    exit(1);
    2b3c:	4505                	li	a0,1
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2b9c:	01850513          	addi	a0,a0,24 # 6bb0 <malloc+0x1092>
    2ba0:	00003097          	auipc	ra,0x3
    2ba4:	ec0080e7          	jalr	-320(ra) # 5a60 <printf>
      exit(1);
    2ba8:	4505                	li	a0,1
    ...
    2bf0:	38450513          	addi	a0,a0,900 # 5f70 <malloc+0x452>
    2bf4:	faa43c23          	sd	a0,-72(s0)
    2bf8:	00003797          	auipc	a5,0x3
    2bfc:	3e878793          	addi	a5,a5,1000 # 5fe0 <malloc+0x4c2>
...
0000000000002c1e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2c2e:	47650513          	addi	a0,a0,1142 # 70a0 <malloc+0x1582>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2c40:	2bc50513          	addi	a0,a0,700 # 6ef8 <malloc+0x13da>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2c56:	2fe50513          	addi	a0,a0,766 # 6f50 <malloc+0x1432>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2c74:	35850513          	addi	a0,a0,856 # 6fc8 <malloc+0x14aa>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2c90:	3ac50513          	addi	a0,a0,940 # 7038 <malloc+0x151a>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2ca2:	3f250513          	addi	a0,a0,1010 # 7090 <malloc+0x1572>
  ...
  unlink("12345678901234");
    ...
    2d20:	1b450513          	addi	a0,a0,436 # 6ed0 <malloc+0x13b2>
    2d24:	00003097          	auipc	ra,0x3
    2d28:	d3c080e7          	jalr	-708(ra) # 5a60 <printf>
    exit(1);
    2d2c:	4505                	li	a0,1
    ...
    2d3c:	1e050513          	addi	a0,a0,480 # 6f18 <malloc+0x13fa>
    2d40:	00003097          	auipc	ra,0x3
    2d44:	d20080e7          	jalr	-736(ra) # 5a60 <printf>
    exit(1);
    2d48:	4505                	li	a0,1
    ...
    2d58:	22c50513          	addi	a0,a0,556 # 6f80 <malloc+0x1462>
    2d5c:	00003097          	auipc	ra,0x3
    2d60:	d04080e7          	jalr	-764(ra) # 5a60 <printf>
    exit(1);
    2d64:	4505                	li	a0,1
    ...
    2d74:	28850513          	addi	a0,a0,648 # 6ff8 <malloc+0x14da>
    2d78:	00003097          	auipc	ra,0x3
    2d7c:	ce8080e7          	jalr	-792(ra) # 5a60 <printf>
    exit(1);
    2d80:	4505                	li	a0,1
    ...
    2d90:	2cc50513          	addi	a0,a0,716 # 7058 <malloc+0x153a>
    2d94:	00003097          	auipc	ra,0x3
    2d98:	ccc080e7          	jalr	-820(ra) # 5a60 <printf>
    exit(1);
    2d9c:	4505                	li	a0,1
    ...
    2dac:	30850513          	addi	a0,a0,776 # 70b0 <malloc+0x1592>
    2db0:	00003097          	auipc	ra,0x3
    2db4:	cb0080e7          	jalr	-848(ra) # 5a60 <printf>
    exit(1);
    2db8:	4505                	li	a0,1
...
0000000000002dc2 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2dd2:	31a50513          	addi	a0,a0,794 # 70e8 <malloc+0x15ca>
  ...
  if(chdir("iputdir") < 0){
    ...
    2de6:	30650513          	addi	a0,a0,774 # 70e8 <malloc+0x15ca>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2dfa:	33250513          	addi	a0,a0,818 # 7128 <malloc+0x160a>
  ...
  if(chdir("/") < 0){
    ...
    2e0e:	34e50513          	addi	a0,a0,846 # 7158 <malloc+0x163a>
    ...
    2e2e:	2c650513          	addi	a0,a0,710 # 70f0 <malloc+0x15d2>
    2e32:	00003097          	auipc	ra,0x3
    2e36:	c2e080e7          	jalr	-978(ra) # 5a60 <printf>
    exit(1);
    2e3a:	4505                	li	a0,1
    ...
    2e4a:	2c250513          	addi	a0,a0,706 # 7108 <malloc+0x15ea>
    2e4e:	00003097          	auipc	ra,0x3
    2e52:	c12080e7          	jalr	-1006(ra) # 5a60 <printf>
    exit(1);
    2e56:	4505                	li	a0,1
    ...
    2e66:	2d650513          	addi	a0,a0,726 # 7138 <malloc+0x161a>
    2e6a:	00003097          	auipc	ra,0x3
    2e6e:	bf6080e7          	jalr	-1034(ra) # 5a60 <printf>
    exit(1);
    2e72:	4505                	li	a0,1
    ...
    2e82:	2e250513          	addi	a0,a0,738 # 7160 <malloc+0x1642>
    2e86:	00003097          	auipc	ra,0x3
    2e8a:	bda080e7          	jalr	-1062(ra) # 5a60 <printf>
    exit(1);
    2e8e:	4505                	li	a0,1
...
0000000000002e98 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2eb6:	23650513          	addi	a0,a0,566 # 70e8 <malloc+0x15ca>
    ...
    2eca:	22250513          	addi	a0,a0,546 # 70e8 <malloc+0x15ca>
    ...
    2ede:	24e50513          	addi	a0,a0,590 # 7128 <malloc+0x160a>
    ...
    2efe:	8ae50513          	addi	a0,a0,-1874 # 67a8 <malloc+0xc8a>
    2f02:	00003097          	auipc	ra,0x3
    2f06:	b5e080e7          	jalr	-1186(ra) # 5a60 <printf>
    exit(1);
    2f0a:	4505                	li	a0,1
    ...
    2f1a:	1da50513          	addi	a0,a0,474 # 70f0 <malloc+0x15d2>
    2f1e:	00003097          	auipc	ra,0x3
    2f22:	b42080e7          	jalr	-1214(ra) # 5a60 <printf>
      exit(1);
    2f26:	4505                	li	a0,1
    ...
    2f36:	24650513          	addi	a0,a0,582 # 7178 <malloc+0x165a>
    2f3a:	00003097          	auipc	ra,0x3
    2f3e:	b26080e7          	jalr	-1242(ra) # 5a60 <printf>
      exit(1);
    2f42:	4505                	li	a0,1
    ...
    2f52:	1ea50513          	addi	a0,a0,490 # 7138 <malloc+0x161a>
    2f56:	00003097          	auipc	ra,0x3
    2f5a:	b0a080e7          	jalr	-1270(ra) # 5a60 <printf>
      exit(1);
    2f5e:	4505                	li	a0,1
...
0000000000002f80 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    2f90:	20450513          	addi	a0,a0,516 # 7190 <malloc+0x1672>
  ...
  if(chdir("dir0") < 0){
    ...
    2fa4:	1f050513          	addi	a0,a0,496 # 7190 <malloc+0x1672>
  ...
  if(chdir("..") < 0){
    ...
    2fb8:	1fc50513          	addi	a0,a0,508 # 71b0 <malloc+0x1692>
  ...
  if(unlink("dir0") < 0){
    ...
    2fcc:	1c850513          	addi	a0,a0,456 # 7190 <malloc+0x1672>
    ...
    2fec:	10850513          	addi	a0,a0,264 # 70f0 <malloc+0x15d2>
    2ff0:	00003097          	auipc	ra,0x3
    2ff4:	a70080e7          	jalr	-1424(ra) # 5a60 <printf>
    exit(1);
    2ff8:	4505                	li	a0,1
    ...
    3008:	19450513          	addi	a0,a0,404 # 7198 <malloc+0x167a>
    300c:	00003097          	auipc	ra,0x3
    3010:	a54080e7          	jalr	-1452(ra) # 5a60 <printf>
    exit(1);
    3014:	4505                	li	a0,1
    ...
    3024:	19850513          	addi	a0,a0,408 # 71b8 <malloc+0x169a>
    3028:	00003097          	auipc	ra,0x3
    302c:	a38080e7          	jalr	-1480(ra) # 5a60 <printf>
    exit(1);
    3030:	4505                	li	a0,1
    ...
    3040:	19450513          	addi	a0,a0,404 # 71d0 <malloc+0x16b2>
    3044:	00003097          	auipc	ra,0x3
    3048:	a1c080e7          	jalr	-1508(ra) # 5a60 <printf>
    exit(1);
    304c:	4505                	li	a0,1
...
0000000000003056 <subdir>:
{
  ...
  unlink("ff");
    ...
    3068:	2b450513          	addi	a0,a0,692 # 7318 <malloc+0x17fa>
    306c:	00002097          	auipc	ra,0x2
    3070:	6c4080e7          	jalr	1732(ra) # 5730 <unlink>
  if(mkdir("dd") != 0){
    3074:	00004517          	auipc	a0,0x4
    3078:	17450513          	addi	a0,a0,372 # 71e8 <malloc+0x16ca>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3090:	17c50513          	addi	a0,a0,380 # 7208 <malloc+0x16ea>
  ...
  write(fd, "ff", 2);
    ...
    30a8:	27458593          	addi	a1,a1,628 # 7318 <malloc+0x17fa>
  ...
  if(unlink("dd") >= 0){
    ...
    30c2:	12a50513          	addi	a0,a0,298 # 71e8 <malloc+0x16ca>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    30d6:	18e50513          	addi	a0,a0,398 # 7260 <malloc+0x1742>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    30ee:	19e50513          	addi	a0,a0,414 # 7288 <malloc+0x176a>
  ...
  write(fd, "FF", 2);
    ...
    3106:	1b658593          	addi	a1,a1,438 # 72b8 <malloc+0x179a>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3122:	1a250513          	addi	a0,a0,418 # 72c0 <malloc+0x17a2>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    316a:	1aa58593          	addi	a1,a1,426 # 7310 <malloc+0x17f2>
    316e:	00004517          	auipc	a0,0x4
    3172:	11a50513          	addi	a0,a0,282 # 7288 <malloc+0x176a>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3186:	10650513          	addi	a0,a0,262 # 7288 <malloc+0x176a>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    319c:	0f050513          	addi	a0,a0,240 # 7288 <malloc+0x176a>
  ...
  if(chdir("dd") != 0){
    ...
    31b0:	03c50513          	addi	a0,a0,60 # 71e8 <malloc+0x16ca>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    31c4:	1e850513          	addi	a0,a0,488 # 73a8 <malloc+0x188a>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    31d8:	20450513          	addi	a0,a0,516 # 73d8 <malloc+0x18ba>
  ...
  if(chdir("./..") != 0){
    ...
    31ec:	22050513          	addi	a0,a0,544 # 7408 <malloc+0x18ea>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3202:	11250513          	addi	a0,a0,274 # 7310 <malloc+0x17f2>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    323c:	05050513          	addi	a0,a0,80 # 7288 <malloc+0x176a>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3254:	24850513          	addi	a0,a0,584 # 7498 <malloc+0x197a>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    326c:	26050513          	addi	a0,a0,608 # 74c8 <malloc+0x19aa>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3284:	f6850513          	addi	a0,a0,-152 # 71e8 <malloc+0x16ca>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    329a:	f5250513          	addi	a0,a0,-174 # 71e8 <malloc+0x16ca>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    32b0:	f3c50513          	addi	a0,a0,-196 # 71e8 <malloc+0x16ca>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    32c4:	29858593          	addi	a1,a1,664 # 7558 <malloc+0x1a3a>
    32c8:	00004517          	auipc	a0,0x4
    32cc:	1d050513          	addi	a0,a0,464 # 7498 <malloc+0x197a>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    32e0:	27c58593          	addi	a1,a1,636 # 7558 <malloc+0x1a3a>
    32e4:	00004517          	auipc	a0,0x4
    32e8:	1e450513          	addi	a0,a0,484 # 74c8 <malloc+0x19aa>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    32fc:	01858593          	addi	a1,a1,24 # 7310 <malloc+0x17f2>
    3300:	00004517          	auipc	a0,0x4
    3304:	f0850513          	addi	a0,a0,-248 # 7208 <malloc+0x16ea>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3318:	18450513          	addi	a0,a0,388 # 7498 <malloc+0x197a>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    332c:	1a050513          	addi	a0,a0,416 # 74c8 <malloc+0x19aa>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3340:	fd450513          	addi	a0,a0,-44 # 7310 <malloc+0x17f2>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3354:	17850513          	addi	a0,a0,376 # 74c8 <malloc+0x19aa>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3368:	13450513          	addi	a0,a0,308 # 7498 <malloc+0x197a>
  ...
  if(chdir("dd/ff") == 0){
    ...
    337c:	e9050513          	addi	a0,a0,-368 # 7208 <malloc+0x16ea>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3390:	31c50513          	addi	a0,a0,796 # 76a8 <malloc+0x1b8a>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    33a4:	f7050513          	addi	a0,a0,-144 # 7310 <malloc+0x17f2>
  ...
  if(unlink("dd/ff") != 0){
    ...
    33b8:	e5450513          	addi	a0,a0,-428 # 7208 <malloc+0x16ea>
  ...
  if(unlink("dd") == 0){
    ...
    33cc:	e2050513          	addi	a0,a0,-480 # 71e8 <malloc+0x16ca>
  ...
  if(unlink("dd/dd") < 0){
    ...
    33e0:	33c50513          	addi	a0,a0,828 # 7718 <malloc+0x1bfa>
  ...
  if(unlink("dd") < 0){
    ...
    33f4:	df850513          	addi	a0,a0,-520 # 71e8 <malloc+0x16ca>
    ...
    3416:	dde50513          	addi	a0,a0,-546 # 71f0 <malloc+0x16d2>
    341a:	00002097          	auipc	ra,0x2
    341e:	646080e7          	jalr	1606(ra) # 5a60 <printf>
    exit(1);
    3422:	4505                	li	a0,1
    ...
    3432:	de250513          	addi	a0,a0,-542 # 7210 <malloc+0x16f2>
    3436:	00002097          	auipc	ra,0x2
    343a:	62a080e7          	jalr	1578(ra) # 5a60 <printf>
    exit(1);
    343e:	4505                	li	a0,1
    ...
    344e:	de650513          	addi	a0,a0,-538 # 7230 <malloc+0x1712>
    3452:	00002097          	auipc	ra,0x2
    3456:	60e080e7          	jalr	1550(ra) # 5a60 <printf>
    exit(1);
    345a:	4505                	li	a0,1
    ...
    346a:	e0250513          	addi	a0,a0,-510 # 7268 <malloc+0x174a>
    346e:	00002097          	auipc	ra,0x2
    3472:	5f2080e7          	jalr	1522(ra) # 5a60 <printf>
    exit(1);
    3476:	4505                	li	a0,1
    ...
    3486:	e1650513          	addi	a0,a0,-490 # 7298 <malloc+0x177a>
    348a:	00002097          	auipc	ra,0x2
    348e:	5d6080e7          	jalr	1494(ra) # 5a60 <printf>
    exit(1);
    3492:	4505                	li	a0,1
    ...
    34a2:	e3250513          	addi	a0,a0,-462 # 72d0 <malloc+0x17b2>
    34a6:	00002097          	auipc	ra,0x2
    34aa:	5ba080e7          	jalr	1466(ra) # 5a60 <printf>
    exit(1);
    34ae:	4505                	li	a0,1
    ...
    34be:	e3650513          	addi	a0,a0,-458 # 72f0 <malloc+0x17d2>
    34c2:	00002097          	auipc	ra,0x2
    34c6:	59e080e7          	jalr	1438(ra) # 5a60 <printf>
    exit(1);
    34ca:	4505                	li	a0,1
    ...
    34da:	e4a50513          	addi	a0,a0,-438 # 7320 <malloc+0x1802>
    34de:	00002097          	auipc	ra,0x2
    34e2:	582080e7          	jalr	1410(ra) # 5a60 <printf>
    exit(1);
    34e6:	4505                	li	a0,1
    ...
    34f6:	e5650513          	addi	a0,a0,-426 # 7348 <malloc+0x182a>
    34fa:	00002097          	auipc	ra,0x2
    34fe:	566080e7          	jalr	1382(ra) # 5a60 <printf>
    exit(1);
    3502:	4505                	li	a0,1
    ...
    3512:	e5a50513          	addi	a0,a0,-422 # 7368 <malloc+0x184a>
    3516:	00002097          	auipc	ra,0x2
    351a:	54a080e7          	jalr	1354(ra) # 5a60 <printf>
    exit(1);
    351e:	4505                	li	a0,1
    ...
    352e:	e6650513          	addi	a0,a0,-410 # 7390 <malloc+0x1872>
    3532:	00002097          	auipc	ra,0x2
    3536:	52e080e7          	jalr	1326(ra) # 5a60 <printf>
    exit(1);
    353a:	4505                	li	a0,1
    ...
    354a:	e7250513          	addi	a0,a0,-398 # 73b8 <malloc+0x189a>
    354e:	00002097          	auipc	ra,0x2
    3552:	512080e7          	jalr	1298(ra) # 5a60 <printf>
    exit(1);
    3556:	4505                	li	a0,1
    ...
    3566:	e8650513          	addi	a0,a0,-378 # 73e8 <malloc+0x18ca>
    356a:	00002097          	auipc	ra,0x2
    356e:	4f6080e7          	jalr	1270(ra) # 5a60 <printf>
    exit(1);
    3572:	4505                	li	a0,1
    ...
    3582:	e9250513          	addi	a0,a0,-366 # 7410 <malloc+0x18f2>
    3586:	00002097          	auipc	ra,0x2
    358a:	4da080e7          	jalr	1242(ra) # 5a60 <printf>
    exit(1);
    358e:	4505                	li	a0,1
    ...
    359e:	e8e50513          	addi	a0,a0,-370 # 7428 <malloc+0x190a>
    35a2:	00002097          	auipc	ra,0x2
    35a6:	4be080e7          	jalr	1214(ra) # 5a60 <printf>
    exit(1);
    35aa:	4505                	li	a0,1
    ...
    35ba:	e9250513          	addi	a0,a0,-366 # 7448 <malloc+0x192a>
    35be:	00002097          	auipc	ra,0x2
    35c2:	4a2080e7          	jalr	1186(ra) # 5a60 <printf>
    exit(1);
    35c6:	4505                	li	a0,1
    ...
    35d6:	e9650513          	addi	a0,a0,-362 # 7468 <malloc+0x194a>
    35da:	00002097          	auipc	ra,0x2
    35de:	486080e7          	jalr	1158(ra) # 5a60 <printf>
    exit(1);
    35e2:	4505                	li	a0,1
    ...
    35f2:	eba50513          	addi	a0,a0,-326 # 74a8 <malloc+0x198a>
    35f6:	00002097          	auipc	ra,0x2
    35fa:	46a080e7          	jalr	1130(ra) # 5a60 <printf>
    exit(1);
    35fe:	4505                	li	a0,1
    ...
    360e:	ece50513          	addi	a0,a0,-306 # 74d8 <malloc+0x19ba>
    3612:	00002097          	auipc	ra,0x2
    3616:	44e080e7          	jalr	1102(ra) # 5a60 <printf>
    exit(1);
    361a:	4505                	li	a0,1
    ...
    362a:	ed250513          	addi	a0,a0,-302 # 74f8 <malloc+0x19da>
    362e:	00002097          	auipc	ra,0x2
    3632:	432080e7          	jalr	1074(ra) # 5a60 <printf>
    exit(1);
    3636:	4505                	li	a0,1
    ...
    3646:	ed650513          	addi	a0,a0,-298 # 7518 <malloc+0x19fa>
    364a:	00002097          	auipc	ra,0x2
    364e:	416080e7          	jalr	1046(ra) # 5a60 <printf>
    exit(1);
    3652:	4505                	li	a0,1
    ...
    3662:	eda50513          	addi	a0,a0,-294 # 7538 <malloc+0x1a1a>
    3666:	00002097          	auipc	ra,0x2
    366a:	3fa080e7          	jalr	1018(ra) # 5a60 <printf>
    exit(1);
    366e:	4505                	li	a0,1
    ...
    367e:	eee50513          	addi	a0,a0,-274 # 7568 <malloc+0x1a4a>
    3682:	00002097          	auipc	ra,0x2
    3686:	3de080e7          	jalr	990(ra) # 5a60 <printf>
    exit(1);
    368a:	4505                	li	a0,1
    ...
    369a:	efa50513          	addi	a0,a0,-262 # 7590 <malloc+0x1a72>
    369e:	00002097          	auipc	ra,0x2
    36a2:	3c2080e7          	jalr	962(ra) # 5a60 <printf>
    exit(1);
    36a6:	4505                	li	a0,1
    ...
    36b6:	f0650513          	addi	a0,a0,-250 # 75b8 <malloc+0x1a9a>
    36ba:	00002097          	auipc	ra,0x2
    36be:	3a6080e7          	jalr	934(ra) # 5a60 <printf>
    exit(1);
    36c2:	4505                	li	a0,1
    ...
    36d2:	f1250513          	addi	a0,a0,-238 # 75e0 <malloc+0x1ac2>
    36d6:	00002097          	auipc	ra,0x2
    36da:	38a080e7          	jalr	906(ra) # 5a60 <printf>
    exit(1);
    36de:	4505                	li	a0,1
    ...
    36ee:	f1650513          	addi	a0,a0,-234 # 7600 <malloc+0x1ae2>
    36f2:	00002097          	auipc	ra,0x2
    36f6:	36e080e7          	jalr	878(ra) # 5a60 <printf>
    exit(1);
    36fa:	4505                	li	a0,1
    ...
    370a:	f1a50513          	addi	a0,a0,-230 # 7620 <malloc+0x1b02>
    370e:	00002097          	auipc	ra,0x2
    3712:	352080e7          	jalr	850(ra) # 5a60 <printf>
    exit(1);
    3716:	4505                	li	a0,1
    ...
    3726:	f2650513          	addi	a0,a0,-218 # 7648 <malloc+0x1b2a>
    372a:	00002097          	auipc	ra,0x2
    372e:	336080e7          	jalr	822(ra) # 5a60 <printf>
    exit(1);
    3732:	4505                	li	a0,1
    ...
    3742:	f2a50513          	addi	a0,a0,-214 # 7668 <malloc+0x1b4a>
    3746:	00002097          	auipc	ra,0x2
    374a:	31a080e7          	jalr	794(ra) # 5a60 <printf>
    exit(1);
    374e:	4505                	li	a0,1
    ...
    375e:	f2e50513          	addi	a0,a0,-210 # 7688 <malloc+0x1b6a>
    3762:	00002097          	auipc	ra,0x2
    3766:	2fe080e7          	jalr	766(ra) # 5a60 <printf>
    exit(1);
    376a:	4505                	li	a0,1
    ...
    377a:	f3a50513          	addi	a0,a0,-198 # 76b0 <malloc+0x1b92>
    377e:	00002097          	auipc	ra,0x2
    3782:	2e2080e7          	jalr	738(ra) # 5a60 <printf>
    exit(1);
    3786:	4505                	li	a0,1
    ...
    3796:	bb650513          	addi	a0,a0,-1098 # 7348 <malloc+0x182a>
    379a:	00002097          	auipc	ra,0x2
    379e:	2c6080e7          	jalr	710(ra) # 5a60 <printf>
    exit(1);
    37a2:	4505                	li	a0,1
    ...
    37b2:	f2250513          	addi	a0,a0,-222 # 76d0 <malloc+0x1bb2>
    37b6:	00002097          	auipc	ra,0x2
    37ba:	2aa080e7          	jalr	682(ra) # 5a60 <printf>
    exit(1);
    37be:	4505                	li	a0,1
    ...
    37ce:	f2650513          	addi	a0,a0,-218 # 76f0 <malloc+0x1bd2>
    37d2:	00002097          	auipc	ra,0x2
    37d6:	28e080e7          	jalr	654(ra) # 5a60 <printf>
    exit(1);
    37da:	4505                	li	a0,1
    ...
    37ea:	f3a50513          	addi	a0,a0,-198 # 7720 <malloc+0x1c02>
    37ee:	00002097          	auipc	ra,0x2
    37f2:	272080e7          	jalr	626(ra) # 5a60 <printf>
    exit(1);
    37f6:	4505                	li	a0,1
    ...
    3806:	f3e50513          	addi	a0,a0,-194 # 7740 <malloc+0x1c22>
    380a:	00002097          	auipc	ra,0x2
    380e:	256080e7          	jalr	598(ra) # 5a60 <printf>
    exit(1);
    3812:	4505                	li	a0,1
...
000000000000381c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    382c:	f3050513          	addi	a0,a0,-208 # 7758 <malloc+0x1c3a>
  ...
  if(chdir("dots") != 0){
    ...
    383e:	f1e50513          	addi	a0,a0,-226 # 7758 <malloc+0x1c3a>
  ...
  if(unlink(".") == 0){
    ...
    3850:	dbc50513          	addi	a0,a0,-580 # 6608 <malloc+0xaea>
  ...
  if(unlink("..") == 0){
    ...
    3862:	95250513          	addi	a0,a0,-1710 # 71b0 <malloc+0x1692>
  ...
  if(chdir("/") != 0){
    ...
    3874:	8e850513          	addi	a0,a0,-1816 # 7158 <malloc+0x163a>
  ...
  if(unlink("dots/.") == 0){
    ...
    3886:	f3e50513          	addi	a0,a0,-194 # 77c0 <malloc+0x1ca2>
  ...
  if(unlink("dots/..") == 0){
    ...
    3898:	f5450513          	addi	a0,a0,-172 # 77e8 <malloc+0x1cca>
  ...
  if(unlink("dots") != 0){
    ...
    38aa:	eb250513          	addi	a0,a0,-334 # 7758 <malloc+0x1c3a>
    ...
    38c8:	e9c50513          	addi	a0,a0,-356 # 7760 <malloc+0x1c42>
    38cc:	00002097          	auipc	ra,0x2
    38d0:	194080e7          	jalr	404(ra) # 5a60 <printf>
    exit(1);
    38d4:	4505                	li	a0,1
    ...
    38e4:	e9850513          	addi	a0,a0,-360 # 7778 <malloc+0x1c5a>
    38e8:	00002097          	auipc	ra,0x2
    38ec:	178080e7          	jalr	376(ra) # 5a60 <printf>
    exit(1);
    38f0:	4505                	li	a0,1
    ...
    3900:	e9450513          	addi	a0,a0,-364 # 7790 <malloc+0x1c72>
    3904:	00002097          	auipc	ra,0x2
    3908:	15c080e7          	jalr	348(ra) # 5a60 <printf>
    exit(1);
    390c:	4505                	li	a0,1
    ...
    391c:	e9050513          	addi	a0,a0,-368 # 77a8 <malloc+0x1c8a>
    3920:	00002097          	auipc	ra,0x2
    3924:	140080e7          	jalr	320(ra) # 5a60 <printf>
    exit(1);
    3928:	4505                	li	a0,1
    ...
    3938:	82c50513          	addi	a0,a0,-2004 # 7160 <malloc+0x1642>
    393c:	00002097          	auipc	ra,0x2
    3940:	124080e7          	jalr	292(ra) # 5a60 <printf>
    exit(1);
    3944:	4505                	li	a0,1
    ...
    3954:	e7850513          	addi	a0,a0,-392 # 77c8 <malloc+0x1caa>
    3958:	00002097          	auipc	ra,0x2
    395c:	108080e7          	jalr	264(ra) # 5a60 <printf>
    exit(1);
    3960:	4505                	li	a0,1
    ...
    3970:	e8450513          	addi	a0,a0,-380 # 77f0 <malloc+0x1cd2>
    3974:	00002097          	auipc	ra,0x2
    3978:	0ec080e7          	jalr	236(ra) # 5a60 <printf>
    exit(1);
    397c:	4505                	li	a0,1
    ...
    398c:	e8850513          	addi	a0,a0,-376 # 7810 <malloc+0x1cf2>
    3990:	00002097          	auipc	ra,0x2
    3994:	0d0080e7          	jalr	208(ra) # 5a60 <printf>
    exit(1);
    3998:	4505                	li	a0,1
...
00000000000039a2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    39b8:	55c50513          	addi	a0,a0,1372 # 5f10 <malloc+0x3f2>
  ...
  if(chdir("dirfile") == 0){
    ...
    39d4:	54050513          	addi	a0,a0,1344 # 5f10 <malloc+0x3f2>
  ...
  fd = open("dirfile/xx", 0);
    ...
    39e8:	e8c50513          	addi	a0,a0,-372 # 7870 <malloc+0x1d52>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3a00:	e7450513          	addi	a0,a0,-396 # 7870 <malloc+0x1d52>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3a14:	e6050513          	addi	a0,a0,-416 # 7870 <malloc+0x1d52>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3a28:	e4c50513          	addi	a0,a0,-436 # 7870 <malloc+0x1d52>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3a3c:	e3858593          	addi	a1,a1,-456 # 7870 <malloc+0x1d52>
    3a40:	00002517          	auipc	a0,0x2
    3a44:	6c850513          	addi	a0,a0,1736 # 6108 <malloc+0x5ea>
  ...
  if(unlink("dirfile") != 0){
    ...
    3a58:	4bc50513          	addi	a0,a0,1212 # 5f10 <malloc+0x3f2>
  ...
  fd = open(".", O_RDWR);
    ...
    3a6e:	b9e50513          	addi	a0,a0,-1122 # 6608 <malloc+0xaea>
  ...
  fd = open(".", 0);
    ...
    3a84:	b8850513          	addi	a0,a0,-1144 # 6608 <malloc+0xaea>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3a98:	54c58593          	addi	a1,a1,1356 # 5fe0 <malloc+0x4c2>
  ...
  close(fd);
    ...
    3ac4:	d7050513          	addi	a0,a0,-656 # 7830 <malloc+0x1d12>
    3ac8:	00002097          	auipc	ra,0x2
    3acc:	f98080e7          	jalr	-104(ra) # 5a60 <printf>
    exit(1);
    3ad0:	4505                	li	a0,1
    ...
    3ae0:	d7450513          	addi	a0,a0,-652 # 7850 <malloc+0x1d32>
    3ae4:	00002097          	auipc	ra,0x2
    3ae8:	f7c080e7          	jalr	-132(ra) # 5a60 <printf>
    exit(1);
    3aec:	4505                	li	a0,1
    ...
    3afc:	d8850513          	addi	a0,a0,-632 # 7880 <malloc+0x1d62>
    3b00:	00002097          	auipc	ra,0x2
    3b04:	f60080e7          	jalr	-160(ra) # 5a60 <printf>
    exit(1);
    3b08:	4505                	li	a0,1
    ...
    3b18:	d6c50513          	addi	a0,a0,-660 # 7880 <malloc+0x1d62>
    3b1c:	00002097          	auipc	ra,0x2
    3b20:	f44080e7          	jalr	-188(ra) # 5a60 <printf>
    exit(1);
    3b24:	4505                	li	a0,1
    ...
    3b34:	d7850513          	addi	a0,a0,-648 # 78a8 <malloc+0x1d8a>
    3b38:	00002097          	auipc	ra,0x2
    3b3c:	f28080e7          	jalr	-216(ra) # 5a60 <printf>
    exit(1);
    3b40:	4505                	li	a0,1
    ...
    3b50:	d8450513          	addi	a0,a0,-636 # 78d0 <malloc+0x1db2>
    3b54:	00002097          	auipc	ra,0x2
    3b58:	f0c080e7          	jalr	-244(ra) # 5a60 <printf>
    exit(1);
    3b5c:	4505                	li	a0,1
    ...
    3b6c:	d9050513          	addi	a0,a0,-624 # 78f8 <malloc+0x1dda>
    3b70:	00002097          	auipc	ra,0x2
    3b74:	ef0080e7          	jalr	-272(ra) # 5a60 <printf>
    exit(1);
    3b78:	4505                	li	a0,1
    ...
    3b88:	d9c50513          	addi	a0,a0,-612 # 7920 <malloc+0x1e02>
    3b8c:	00002097          	auipc	ra,0x2
    3b90:	ed4080e7          	jalr	-300(ra) # 5a60 <printf>
    exit(1);
    3b94:	4505                	li	a0,1
    ...
    3ba4:	da050513          	addi	a0,a0,-608 # 7940 <malloc+0x1e22>
    3ba8:	00002097          	auipc	ra,0x2
    3bac:	eb8080e7          	jalr	-328(ra) # 5a60 <printf>
    exit(1);
    3bb0:	4505                	li	a0,1
    ...
    3bc0:	dac50513          	addi	a0,a0,-596 # 7968 <malloc+0x1e4a>
    3bc4:	00002097          	auipc	ra,0x2
    3bc8:	e9c080e7          	jalr	-356(ra) # 5a60 <printf>
    exit(1);
    3bcc:	4505                	li	a0,1
...
0000000000003bd6 <iref>:
{
    ...
    3bf4:	d90a0a13          	addi	s4,s4,-624 # 7980 <malloc+0x1e62>
    mkdir("");
    3bf8:	00004497          	auipc	s1,0x4
    3bfc:	89848493          	addi	s1,s1,-1896 # 7490 <malloc+0x1972>
    link("README", "");
    3c00:	00002a97          	auipc	s5,0x2
    3c04:	508a8a93          	addi	s5,s5,1288 # 6108 <malloc+0x5ea>
    fd = open("xx", O_CREATE);
    3c08:	00004997          	auipc	s3,0x4
    3c0c:	c7098993          	addi	s3,s3,-912 # 7878 <malloc+0x1d5a>
    3c10:	a891                	j	3c64 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3c12:	85da                	mv	a1,s6
    3c14:	00004517          	auipc	a0,0x4
    3c18:	d7450513          	addi	a0,a0,-652 # 7988 <malloc+0x1e6a>
    3c1c:	00002097          	auipc	ra,0x2
    3c20:	e44080e7          	jalr	-444(ra) # 5a60 <printf>
      exit(1);
    3c24:	4505                	li	a0,1
    ...
    3c34:	d7050513          	addi	a0,a0,-656 # 79a0 <malloc+0x1e82>
    3c38:	00002097          	auipc	ra,0x2
    3c3c:	e28080e7          	jalr	-472(ra) # 5a60 <printf>
      exit(1);
    3c40:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3cc8:	4ec98993          	addi	s3,s3,1260 # 71b0 <malloc+0x1692>
    unlink("irefd");
    3ccc:	00004917          	auipc	s2,0x4
    3cd0:	cb490913          	addi	s2,s2,-844 # 7980 <malloc+0x1e62>
    chdir("..");
    3cd4:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3cf0:	46c50513          	addi	a0,a0,1132 # 7158 <malloc+0x163a>
...
0000000000003d10 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3d20:	c9c50513          	addi	a0,a0,-868 # 79b8 <malloc+0x1e9a>
  ...
  if(pid == 0){
    ...
    3d44:	c7850513          	addi	a0,a0,-904 # 79b8 <malloc+0x1e9a>
    ...
    3d5a:	c8250513          	addi	a0,a0,-894 # 79d8 <malloc+0x1eba>
    3d5e:	00002097          	auipc	ra,0x2
    3d62:	d02080e7          	jalr	-766(ra) # 5a60 <printf>
      exit(1);
    3d66:	4505                	li	a0,1
    ...
    3d76:	c4e50513          	addi	a0,a0,-946 # 79c0 <malloc+0x1ea2>
    3d7a:	00002097          	auipc	ra,0x2
    3d7e:	ce6080e7          	jalr	-794(ra) # 5a60 <printf>
    exit(1);
    3d82:	4505                	li	a0,1
    ...
    3d92:	a1a50513          	addi	a0,a0,-1510 # 67a8 <malloc+0xc8a>
    3d96:	00002097          	auipc	ra,0x2
    3d9a:	cca080e7          	jalr	-822(ra) # 5a60 <printf>
    exit(1);
    3d9e:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3dc0:	bfc50513          	addi	a0,a0,-1028 # 79b8 <malloc+0x1e9a>
    ...
    3dd4:	bc850513          	addi	a0,a0,-1080 # 6998 <malloc+0xe7a>
    3dd8:	00002097          	auipc	ra,0x2
    3ddc:	c88080e7          	jalr	-888(ra) # 5a60 <printf>
    exit(1);
    3de0:	4505                	li	a0,1
...
0000000000003e02 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3e12:	bf250513          	addi	a0,a0,-1038 # 7a00 <malloc+0x1ee2>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3e3e:	bc650513          	addi	a0,a0,-1082 # 7a00 <malloc+0x1ee2>
  ...
  sleep(10); // one second
    ...
    3e76:	af650513          	addi	a0,a0,-1290 # 6968 <malloc+0xe4a>
    3e7a:	00002097          	auipc	ra,0x2
    3e7e:	be6080e7          	jalr	-1050(ra) # 5a60 <printf>
    exit(1);
    3e82:	4505                	li	a0,1
    ...
    3e90:	b7448493          	addi	s1,s1,-1164 # 7a00 <malloc+0x1ee2>
    3e94:	4581                	li	a1,0
    3e96:	8526                	mv	a0,s1
...
0000000000003ed2 <killstatus>:
{
  ...
  exit(0);
    ...
    3f38:	87450513          	addi	a0,a0,-1932 # 67a8 <malloc+0xc8a>
    3f3c:	00002097          	auipc	ra,0x2
    3f40:	b24080e7          	jalr	-1244(ra) # 5a60 <printf>
      exit(1);
    3f44:	4505                	li	a0,1
    ...
    3f5e:	ab650513          	addi	a0,a0,-1354 # 7a10 <malloc+0x1ef2>
    3f62:	00002097          	auipc	ra,0x2
    3f66:	afe080e7          	jalr	-1282(ra) # 5a60 <printf>
       exit(1);
    3f6a:	4505                	li	a0,1
...
0000000000003f74 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3f9e:	9ce50513          	addi	a0,a0,-1586 # 6968 <malloc+0xe4a>
    3fa2:	00002097          	auipc	ra,0x2
    3fa6:	abe080e7          	jalr	-1346(ra) # 5a60 <printf>
    exit(1);
    3faa:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3fcc:	7e050513          	addi	a0,a0,2016 # 67a8 <malloc+0xc8a>
    3fd0:	00002097          	auipc	ra,0x2
    3fd4:	a90080e7          	jalr	-1392(ra) # 5a60 <printf>
    exit(1);
    3fd8:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4010:	fd458593          	addi	a1,a1,-44 # 5fe0 <malloc+0x4c2>
    ...
    403a:	77250513          	addi	a0,a0,1906 # 67a8 <malloc+0xc8a>
    403e:	00002097          	auipc	ra,0x2
    4042:	a22080e7          	jalr	-1502(ra) # 5a60 <printf>
     exit(1);
    4046:	4505                	li	a0,1
    ...
    4056:	9de50513          	addi	a0,a0,-1570 # 7a30 <malloc+0x1f12>
    405a:	00002097          	auipc	ra,0x2
    405e:	a06080e7          	jalr	-1530(ra) # 5a60 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4092:	9ba50513          	addi	a0,a0,-1606 # 7a48 <malloc+0x1f2a>
    4096:	00002097          	auipc	ra,0x2
    409a:	9ca080e7          	jalr	-1590(ra) # 5a60 <printf>
}
  ...
  printf("kill... ");
    ...
    40be:	9a650513          	addi	a0,a0,-1626 # 7a60 <malloc+0x1f42>
    40c2:	00002097          	auipc	ra,0x2
    40c6:	99e080e7          	jalr	-1634(ra) # 5a60 <printf>
  kill(pid1);
    40ca:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    40ec:	98850513          	addi	a0,a0,-1656 # 7a70 <malloc+0x1f52>
    40f0:	00002097          	auipc	ra,0x2
    40f4:	970080e7          	jalr	-1680(ra) # 5a60 <printf>
  wait(0);
    40f8:	4501                	li	a0,0
...
0000000000004118 <reparent>:
{
  ...
  exit(0);
    ...
    416c:	64050513          	addi	a0,a0,1600 # 67a8 <malloc+0xc8a>
    4170:	00002097          	auipc	ra,0x2
    4174:	8f0080e7          	jalr	-1808(ra) # 5a60 <printf>
      exit(1);
    4178:	4505                	li	a0,1
    ...
    4188:	7ac50513          	addi	a0,a0,1964 # 6930 <malloc+0xe12>
    418c:	00002097          	auipc	ra,0x2
    4190:	8d4080e7          	jalr	-1836(ra) # 5a60 <printf>
        exit(1);
    4194:	4505                	li	a0,1
...
00000000000041c8 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    41fe:	6b650513          	addi	a0,a0,1718 # 68b0 <malloc+0xd92>
    4202:	00002097          	auipc	ra,0x2
    4206:	85e080e7          	jalr	-1954(ra) # 5a60 <printf>
    exit(1);
    420a:	4505                	li	a0,1
    ...
    4232:	db258593          	addi	a1,a1,-590 # 5fe0 <malloc+0x4c2>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    42f6:	78e50513          	addi	a0,a0,1934 # 7a80 <malloc+0x1f62>
    42fa:	00001097          	auipc	ra,0x1
    42fe:	766080e7          	jalr	1894(ra) # 5a60 <printf>
    exit(1);
    4302:	4505                	li	a0,1
    ...
    4312:	49a50513          	addi	a0,a0,1178 # 67a8 <malloc+0xc8a>
    4316:	00001097          	auipc	ra,0x1
    431a:	74a080e7          	jalr	1866(ra) # 5a60 <printf>
    exit(1);
    431e:	4505                	li	a0,1
    ...
    435e:	74650513          	addi	a0,a0,1862 # 7aa0 <malloc+0x1f82>
    4362:	00001097          	auipc	ra,0x1
    4366:	6fe080e7          	jalr	1790(ra) # 5a60 <printf>
    exit(1);
    436a:	4505                	li	a0,1
...
000000000000437e <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    43c8:	75a080e7          	jalr	1882(ra) # 5b1e <malloc>
    ...
    4402:	6d250513          	addi	a0,a0,1746 # 7ad0 <malloc+0x1fb2>
    4406:	00001097          	auipc	ra,0x1
    440a:	65a080e7          	jalr	1626(ra) # 5a60 <printf>
      exit(1);
    440e:	4505                	li	a0,1
...
0000000000004422 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    44b8:	63c50513          	addi	a0,a0,1596 # 7af0 <malloc+0x1fd2>
    44bc:	00001097          	auipc	ra,0x1
    44c0:	5a4080e7          	jalr	1444(ra) # 5a60 <printf>
    exit(1);
    44c4:	4505                	li	a0,1
    ...
    44d4:	64850513          	addi	a0,a0,1608 # 7b18 <malloc+0x1ffa>
    44d8:	00001097          	auipc	ra,0x1
    44dc:	588080e7          	jalr	1416(ra) # 5a60 <printf>
      exit(1);
    44e0:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4518:	88c50513          	addi	a0,a0,-1908 # 5da0 <malloc+0x282>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4558:	5e450513          	addi	a0,a0,1508 # 7b38 <malloc+0x201a>
    455c:	00001097          	auipc	ra,0x1
    4560:	504080e7          	jalr	1284(ra) # 5a60 <printf>
    exit(1);
    4564:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4594:	81050513          	addi	a0,a0,-2032 # 5da0 <malloc+0x282>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    45ba:	5aa50513          	addi	a0,a0,1450 # 7b60 <malloc+0x2042>
    45be:	00001097          	auipc	ra,0x1
    45c2:	4a2080e7          	jalr	1186(ra) # 5a60 <printf>
    exit(1);
    45c6:	4505                	li	a0,1
...
00000000000045da <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4600:	60c78793          	addi	a5,a5,1548 # 5c08 <malloc+0xea>
    4604:	f6f43823          	sd	a5,-144(s0)
    4608:	00001797          	auipc	a5,0x1
    460c:	60878793          	addi	a5,a5,1544 # 5c10 <malloc+0xf2>
    4610:	f6f43c23          	sd	a5,-136(s0)
    4614:	00001797          	auipc	a5,0x1
    4618:	60478793          	addi	a5,a5,1540 # 5c18 <malloc+0xfa>
    461c:	f8f43023          	sd	a5,-128(s0)
    4620:	00001797          	auipc	a5,0x1
    4624:	60078793          	addi	a5,a5,1536 # 5c20 <malloc+0x102>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    469c:	51850513          	addi	a0,a0,1304 # 6bb0 <malloc+0x1092>
    46a0:	00001097          	auipc	ra,0x1
    46a4:	3c0080e7          	jalr	960(ra) # 5a60 <printf>
      exit(1);
    46a8:	4505                	li	a0,1
    ...
    4718:	46450513          	addi	a0,a0,1124 # 7b78 <malloc+0x205a>
    471c:	00001097          	auipc	ra,0x1
    4720:	344080e7          	jalr	836(ra) # 5a60 <printf>
        exit(1);
    4724:	4505                	li	a0,1
    ...
    4732:	45a50513          	addi	a0,a0,1114 # 7b88 <malloc+0x206a>
    4736:	00001097          	auipc	ra,0x1
    473a:	32a080e7          	jalr	810(ra) # 5a60 <printf>
          exit(1);
    473e:	4505                	li	a0,1
    ...
    475a:	44a50513          	addi	a0,a0,1098 # 7ba0 <malloc+0x2082>
    475e:	00001097          	auipc	ra,0x1
    4762:	302080e7          	jalr	770(ra) # 5a60 <printf>
          exit(1);
    4766:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    47e8:	3cc50513          	addi	a0,a0,972 # 7bb0 <malloc+0x2092>
    47ec:	00001097          	auipc	ra,0x1
    47f0:	274080e7          	jalr	628(ra) # 5a60 <printf>
      exit(1);
    47f4:	4505                	li	a0,1
...
000000000000481c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    484a:	382b8b93          	addi	s7,s7,898 # 7bc8 <malloc+0x20aa>
  for(i = 0; i < N; i++){
    ...
    488c:	34850513          	addi	a0,a0,840 # 7bd0 <malloc+0x20b2>
    4890:	00001097          	auipc	ra,0x1
    4894:	1d0080e7          	jalr	464(ra) # 5a60 <printf>
        exit(1);
    4898:	4505                	li	a0,1
    ...
    48aa:	32250513          	addi	a0,a0,802 # 7bc8 <malloc+0x20aa>
  ...
  fd = open(".", 0);
    ...
    48e2:	d2a50513          	addi	a0,a0,-726 # 6608 <malloc+0xaea>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4958:	29c50513          	addi	a0,a0,668 # 7bf0 <malloc+0x20d2>
    495c:	00001097          	auipc	ra,0x1
    4960:	104080e7          	jalr	260(ra) # 5a60 <printf>
        exit(1);
    4964:	4505                	li	a0,1
    ...
    4978:	29c50513          	addi	a0,a0,668 # 7c10 <malloc+0x20f2>
    497c:	00001097          	auipc	ra,0x1
    4980:	0e4080e7          	jalr	228(ra) # 5a60 <printf>
        exit(1);
    4984:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    49b0:	28c50513          	addi	a0,a0,652 # 7c38 <malloc+0x211a>
    49b4:	00001097          	auipc	ra,0x1
    49b8:	0ac080e7          	jalr	172(ra) # 5a60 <printf>
    exit(1);
    49bc:	4505                	li	a0,1
    ...
    49cc:	de050513          	addi	a0,a0,-544 # 67a8 <malloc+0xc8a>
    49d0:	00001097          	auipc	ra,0x1
    49d4:	090080e7          	jalr	144(ra) # 5a60 <printf>
      exit(1);
    49d8:	4505                	li	a0,1
...
0000000000004b76 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    4bfe:	07650513          	addi	a0,a0,118 # 7c70 <malloc+0x2152>
  ...
  for(i = 0; ; i++){
    ...
    4c62:	02250513          	addi	a0,a0,34 # 7c80 <malloc+0x2162>
    4c66:	00001097          	auipc	ra,0x1
    4c6a:	dfa080e7          	jalr	-518(ra) # 5a60 <printf>
    exit(1);
    4c6e:	4505                	li	a0,1
    ...
    4c7e:	02650513          	addi	a0,a0,38 # 7ca0 <malloc+0x2182>
    4c82:	00001097          	auipc	ra,0x1
    4c86:	dde080e7          	jalr	-546(ra) # 5a60 <printf>
      exit(1);
    4c8a:	4505                	li	a0,1
    ...
    4c9a:	02a50513          	addi	a0,a0,42 # 7cc0 <malloc+0x21a2>
    4c9e:	00001097          	auipc	ra,0x1
    4ca2:	dc2080e7          	jalr	-574(ra) # 5a60 <printf>
    exit(1);
    4ca6:	4505                	li	a0,1
    ...
    4cb6:	02e50513          	addi	a0,a0,46 # 7ce0 <malloc+0x21c2>
    4cba:	00001097          	auipc	ra,0x1
    4cbe:	da6080e7          	jalr	-602(ra) # 5a60 <printf>
      exit(1);
    4cc2:	4505                	li	a0,1
    ...
    4cd2:	03250513          	addi	a0,a0,50 # 7d00 <malloc+0x21e2>
    4cd6:	00001097          	auipc	ra,0x1
    4cda:	d8a080e7          	jalr	-630(ra) # 5a60 <printf>
      exit(1);
    4cde:	4505                	li	a0,1
    ...
    4cee:	02e50513          	addi	a0,a0,46 # 7d18 <malloc+0x21fa>
    4cf2:	00001097          	auipc	ra,0x1
    4cf6:	d6e080e7          	jalr	-658(ra) # 5a60 <printf>
      exit(1);
    4cfa:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4d1c:	f5850513          	addi	a0,a0,-168 # 7c70 <malloc+0x2152>
    ...
    4d40:	ffc50513          	addi	a0,a0,-4 # 7d38 <malloc+0x221a>
    4d44:	00001097          	auipc	ra,0x1
    4d48:	d1c080e7          	jalr	-740(ra) # 5a60 <printf>
    exit(1);
    4d4c:	4505                	li	a0,1
...
0000000000004d56 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4d78:	fe450513          	addi	a0,a0,-28 # 7d58 <malloc+0x223a>
    4d7c:	00001097          	auipc	ra,0x1
    4d80:	ce4080e7          	jalr	-796(ra) # 5a60 <printf>
  for(nfiles = 0; ; nfiles++){
    4d84:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4d98:	fd4c8c93          	addi	s9,s9,-44 # 7d68 <malloc+0x224a>
    int total = 0;
    4d9c:	4d81                	li	s11,0
    ...
    4df0:	c74080e7          	jalr	-908(ra) # 5a60 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4e12:	f6a50513          	addi	a0,a0,-150 # 7d78 <malloc+0x225a>
    4e16:	00001097          	auipc	ra,0x1
    4e1a:	c4a080e7          	jalr	-950(ra) # 5a60 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4e88:	f1450513          	addi	a0,a0,-236 # 7d98 <malloc+0x227a>
    4e8c:	00001097          	auipc	ra,0x1
    4e90:	bd4080e7          	jalr	-1068(ra) # 5a60 <printf>
}
    ...
    4ed8:	eb450513          	addi	a0,a0,-332 # 7d88 <malloc+0x226a>
    4edc:	00001097          	auipc	ra,0x1
    4ee0:	b84080e7          	jalr	-1148(ra) # 5a60 <printf>
    close(fd);
    4ee4:	854a                	mv	a0,s2
...
0000000000004f26 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4f9a:	e1a50513          	addi	a0,a0,-486 # 7db0 <malloc+0x2292>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4fb2:	03258593          	addi	a1,a1,50 # 5fe0 <malloc+0x4c2>
    ...
    4fc8:	e0c50513          	addi	a0,a0,-500 # 7dd0 <malloc+0x22b2>
    4fcc:	00001097          	auipc	ra,0x1
    4fd0:	a94080e7          	jalr	-1388(ra) # 5a60 <printf>
    exit(1);
    4fd4:	4505                	li	a0,1
    ...
    4fe2:	dda50513          	addi	a0,a0,-550 # 7db8 <malloc+0x229a>
    4fe6:	00001097          	auipc	ra,0x1
    4fea:	a7a080e7          	jalr	-1414(ra) # 5a60 <printf>
      exit(1);
    4fee:	4505                	li	a0,1
    ...
    4ffc:	dc050513          	addi	a0,a0,-576 # 7db8 <malloc+0x229a>
    5000:	00001097          	auipc	ra,0x1
    5004:	a60080e7          	jalr	-1440(ra) # 5a60 <printf>
    exit(1);
    5008:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    5020:	d9450513          	addi	a0,a0,-620 # 7db0 <malloc+0x2292>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5076:	f6e98993          	addi	s3,s3,-146 # 5fe0 <malloc+0x4c2>
      uint64 a = (uint64) sbrk(4096);
    ...
    50a8:	d7c50513          	addi	a0,a0,-644 # 7e20 <malloc+0x2302>
    50ac:	00001097          	auipc	ra,0x1
    50b0:	9b4080e7          	jalr	-1612(ra) # 5a60 <printf>
        exit(1);
    50b4:	4505                	li	a0,1
    ...
    50c2:	d2250513          	addi	a0,a0,-734 # 7de0 <malloc+0x22c2>
    50c6:	00001097          	auipc	ra,0x1
    50ca:	99a080e7          	jalr	-1638(ra) # 5a60 <printf>
    exit(1);
    50ce:	4505                	li	a0,1
    ...
    50dc:	d2850513          	addi	a0,a0,-728 # 7e00 <malloc+0x22e2>
    50e0:	00001097          	auipc	ra,0x1
    50e4:	980080e7          	jalr	-1664(ra) # 5a60 <printf>
    exit(1);
    50e8:	4505                	li	a0,1
  ...
  while(1){
    ...
    512a:	d1a50513          	addi	a0,a0,-742 # 7e40 <malloc+0x2322>
    512e:	00001097          	auipc	ra,0x1
    5132:	932080e7          	jalr	-1742(ra) # 5a60 <printf>
      exit(1);
    5136:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    517a:	cea50513          	addi	a0,a0,-790 # 7e60 <malloc+0x2342>
    517e:	00001097          	auipc	ra,0x1
    5182:	8e2080e7          	jalr	-1822(ra) # 5a60 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    51aa:	ce250513          	addi	a0,a0,-798 # 7e88 <malloc+0x236a>
    51ae:	00001097          	auipc	ra,0x1
    51b2:	8b2080e7          	jalr	-1870(ra) # 5a60 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    51ce:	ca650513          	addi	a0,a0,-858 # 7e70 <malloc+0x2352>
    51d2:	00001097          	auipc	ra,0x1
    51d6:	88e080e7          	jalr	-1906(ra) # 5a60 <printf>
    exit(1);
    51da:	4505                	li	a0,1
    ...
    51f6:	c9e50513          	addi	a0,a0,-866 # 7e90 <malloc+0x2372>
    51fa:	00001097          	auipc	ra,0x1
    51fe:	866080e7          	jalr	-1946(ra) # 5a60 <printf>
...
printf("ut 2\n");
    ...
    5234:	c6850513          	addi	a0,a0,-920 # 7e98 <malloc+0x237a>
    5238:	00001097          	auipc	ra,0x1
    523c:	828080e7          	jalr	-2008(ra) # 5a60 <printf>
  ...
  printf("ut 1\n");
    ...
    5252:	d1250513          	addi	a0,a0,-750 # 7f60 <malloc+0x2442>
    5256:	00001097          	auipc	ra,0x1
    525a:	80a080e7          	jalr	-2038(ra) # 5a60 <printf>
  struct test {
    void (*f)(char *);
    char *s;
  } tests[] = {
    525e:	00003797          	auipc	a5,0x3
    5262:	d6a78793          	addi	a5,a5,-662 # 7fc8 <malloc+0x24aa>
    5266:	c0040713          	addi	a4,s0,-1024
    526a:	00003817          	auipc	a6,0x3
    526e:	11e80813          	addi	a6,a6,286 # 8388 <malloc+0x286a>
  ...
  printf("usertests starting\n");
    ...
    5292:	cda50513          	addi	a0,a0,-806 # 7f68 <malloc+0x244a>
    5296:	00000097          	auipc	ra,0x0
    529a:	7ca080e7          	jalr	1994(ra) # 5a60 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    52cc:	c5050513          	addi	a0,a0,-944 # 7f18 <malloc+0x23fa>
    52d0:	00000097          	auipc	ra,0x0
    52d4:	790080e7          	jalr	1936(ra) # 5a60 <printf>
    exit(1);
    52d8:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    52e6:	bbe58593          	addi	a1,a1,-1090 # 7ea0 <malloc+0x2382>
    ...
    52fa:	caa58593          	addi	a1,a1,-854 # 7fa0 <malloc+0x2482>
    ...
    531e:	b9e50513          	addi	a0,a0,-1122 # 7eb8 <malloc+0x239a>
    5322:	00000097          	auipc	ra,0x0
    5326:	73e080e7          	jalr	1854(ra) # 5a60 <printf>
    exit(1);
    532a:	4505                	li	a0,1
    ...
    5338:	b7450513          	addi	a0,a0,-1164 # 7ea8 <malloc+0x238a>
    533c:	00000097          	auipc	ra,0x0
    5340:	724080e7          	jalr	1828(ra) # 5a60 <printf>
    continuous = 1;
    5344:	4985                	li	s3,1
  printf("ut 1\n");
    5346:	00003517          	auipc	a0,0x3
    534a:	c1a50513          	addi	a0,a0,-998 # 7f60 <malloc+0x2442>
    534e:	00000097          	auipc	ra,0x0
    5352:	712080e7          	jalr	1810(ra) # 5a60 <printf>
  } tests[] = {
    5356:	00003797          	auipc	a5,0x3
    535a:	c7278793          	addi	a5,a5,-910 # 7fc8 <malloc+0x24aa>
    535e:	c0040713          	addi	a4,s0,-1024
    5362:	00003817          	auipc	a6,0x3
    5366:	02680813          	addi	a6,a6,38 # 8388 <malloc+0x286a>
    ...
    538a:	bfa50513          	addi	a0,a0,-1030 # 7f80 <malloc+0x2462>
    538e:	00000097          	auipc	ra,0x0
    5392:	6d2080e7          	jalr	1746(ra) # 5a60 <printf>
        printf("SOME TESTS FAILED\n");
    5396:	00003a97          	auipc	s5,0x3
    539a:	b6aa8a93          	addi	s5,s5,-1174 # 7f00 <malloc+0x23e2>
        if(continuous != 2)
    539e:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    53a0:	00003b17          	auipc	s6,0x3
    53a4:	b40b0b13          	addi	s6,s6,-1216 # 7ee0 <malloc+0x23c2>
    ...
    53be:	6a6080e7          	jalr	1702(ra) # 5a60 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5400:	b0450513          	addi	a0,a0,-1276 # 7f00 <malloc+0x23e2>
    5404:	00000097          	auipc	ra,0x0
    5408:	65c080e7          	jalr	1628(ra) # 5a60 <printf>
    exit(1);
    540c:	4505                	li	a0,1
    ...
    541a:	b3250513          	addi	a0,a0,-1230 # 7f48 <malloc+0x242a>
    541e:	00000097          	auipc	ra,0x0
    5422:	642080e7          	jalr	1602(ra) # 5a60 <printf>
    exit(0);
    5426:	4501                	li	a0,0
    ...
    5436:	62e080e7          	jalr	1582(ra) # 5a60 <printf>
        if(continuous != 2)
...
putc(int fd, char c)
{
    ...
    5790:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5794:	4605                	li	a2,1
    5796:	fef40593          	addi	a1,s0,-17
    579a:	00000097          	auipc	ra,0x0
    579e:	f66080e7          	jalr	-154(ra) # 5700 <write>
}
    57a2:	60e2                	ld	ra,24(sp)
    57a4:	6442                	ld	s0,16(sp)
    57a6:	6105                	addi	sp,sp,32
    57a8:	8082                	ret

00000000000057aa <printint>:
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
    57ba:	c299                	beqz	a3,57c0 <printint+0x16>
    57bc:	0805c863          	bltz	a1,584c <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    57c0:	2581                	sext.w	a1,a1
  neg = 0;
    57c2:	4881                	li	a7,0
    57c4:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    57ca:	2601                	sext.w	a2,a2
    57cc:	00003517          	auipc	a0,0x3
    57d0:	bc450513          	addi	a0,a0,-1084 # 8390 <digits>
    57d4:	883a                	mv	a6,a4
    57d6:	2705                	addiw	a4,a4,1
    57d8:	02c5f7bb          	remuw	a5,a1,a2
    57dc:	1782                	slli	a5,a5,0x20
    57de:	9381                	srli	a5,a5,0x20
    57e0:	97aa                	add	a5,a5,a0
    57e2:	0007c783          	lbu	a5,0(a5)
    57e6:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    57ea:	0005879b          	sext.w	a5,a1
    57ee:	02c5d5bb          	divuw	a1,a1,a2
    57f2:	0685                	addi	a3,a3,1
    57f4:	fec7f0e3          	bgeu	a5,a2,57d4 <printint+0x2a>
  if(neg)
    57f8:	00088b63          	beqz	a7,580e <printint+0x64>
    buf[i++] = '-';
    57fc:	fd040793          	addi	a5,s0,-48
    5800:	973e                	add	a4,a4,a5
    5802:	02d00793          	li	a5,45
    5806:	fef70823          	sb	a5,-16(a4)
    580a:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    580e:	02e05863          	blez	a4,583e <printint+0x94>
    5812:	fc040793          	addi	a5,s0,-64
    5816:	00e78933          	add	s2,a5,a4
    581a:	fff78993          	addi	s3,a5,-1
    581e:	99ba                	add	s3,s3,a4
    5820:	377d                	addiw	a4,a4,-1
    5822:	1702                	slli	a4,a4,0x20
    5824:	9301                	srli	a4,a4,0x20
    5826:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    582a:	fff94583          	lbu	a1,-1(s2)
    582e:	8526                	mv	a0,s1
    5830:	00000097          	auipc	ra,0x0
    5834:	f58080e7          	jalr	-168(ra) # 5788 <putc>
  while(--i >= 0)
    5838:	197d                	addi	s2,s2,-1
    583a:	ff3918e3          	bne	s2,s3,582a <printint+0x80>
}
    583e:	70e2                	ld	ra,56(sp)
    5840:	7442                	ld	s0,48(sp)
    5842:	74a2                	ld	s1,40(sp)
    5844:	7902                	ld	s2,32(sp)
    5846:	69e2                	ld	s3,24(sp)
    5848:	6121                	addi	sp,sp,64
    584a:	8082                	ret
    x = -xx;
    584c:	40b005bb          	negw	a1,a1
    neg = 1;
    5850:	4885                	li	a7,1
    x = -xx;
    5852:	bf8d                	j	57c4 <printint+0x1a>

0000000000005854 <vprintf>:
}
...
{
    5854:	7119                	addi	sp,sp,-128
    5856:	fc86                	sd	ra,120(sp)
    5858:	f8a2                	sd	s0,112(sp)
    585a:	f4a6                	sd	s1,104(sp)
    585c:	f0ca                	sd	s2,96(sp)
    585e:	ecce                	sd	s3,88(sp)
    5860:	e8d2                	sd	s4,80(sp)
    5862:	e4d6                	sd	s5,72(sp)
    5864:	e0da                	sd	s6,64(sp)
    5866:	fc5e                	sd	s7,56(sp)
    5868:	f862                	sd	s8,48(sp)
    586a:	f466                	sd	s9,40(sp)
    586c:	f06a                	sd	s10,32(sp)
    586e:	ec6e                	sd	s11,24(sp)
    5870:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5872:	0005c903          	lbu	s2,0(a1)
    5876:	18090f63          	beqz	s2,5a14 <vprintf+0x1c0>
    587a:	8aaa                	mv	s5,a0
    587c:	8b32                	mv	s6,a2
    587e:	00158493          	addi	s1,a1,1
  state = 0;
    5882:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5884:	02500a13          	li	s4,37
      if(c == 'd'){
    5888:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    588c:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5890:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5894:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5898:	00003b97          	auipc	s7,0x3
    589c:	af8b8b93          	addi	s7,s7,-1288 # 8390 <digits>
    58a0:	a839                	j	58be <vprintf+0x6a>
        putc(fd, c);
    58a2:	85ca                	mv	a1,s2
    58a4:	8556                	mv	a0,s5
    58a6:	00000097          	auipc	ra,0x0
    58aa:	ee2080e7          	jalr	-286(ra) # 5788 <putc>
    58ae:	a019                	j	58b4 <vprintf+0x60>
    } else if(state == '%'){
    58b0:	01498f63          	beq	s3,s4,58ce <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    58b4:	0485                	addi	s1,s1,1
    58b6:	fff4c903          	lbu	s2,-1(s1)
    58ba:	14090d63          	beqz	s2,5a14 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    58be:	0009079b          	sext.w	a5,s2
    if(state == 0){
    58c2:	fe0997e3          	bnez	s3,58b0 <vprintf+0x5c>
      if(c == '%'){
    58c6:	fd479ee3          	bne	a5,s4,58a2 <vprintf+0x4e>
        state = '%';
    58ca:	89be                	mv	s3,a5
    58cc:	b7e5                	j	58b4 <vprintf+0x60>
      if(c == 'd'){
    58ce:	05878063          	beq	a5,s8,590e <vprintf+0xba>
      } else if(c == 'l') {
    58d2:	05978c63          	beq	a5,s9,592a <vprintf+0xd6>
      } else if(c == 'x') {
    58d6:	07a78863          	beq	a5,s10,5946 <vprintf+0xf2>
      } else if(c == 'p') {
    58da:	09b78463          	beq	a5,s11,5962 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    58de:	07300713          	li	a4,115
    58e2:	0ce78663          	beq	a5,a4,59ae <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    58e6:	06300713          	li	a4,99
    58ea:	0ee78e63          	beq	a5,a4,59e6 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    58ee:	11478863          	beq	a5,s4,59fe <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    58fa:	e92080e7          	jalr	-366(ra) # 5788 <putc>
        putc(fd, c);
    58fe:	85ca                	mv	a1,s2
    5900:	8556                	mv	a0,s5
    5902:	00000097          	auipc	ra,0x0
    5906:	e86080e7          	jalr	-378(ra) # 5788 <putc>
      }
      state = 0;
    590a:	4981                	li	s3,0
    590c:	b765                	j	58b4 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    5920:	e8e080e7          	jalr	-370(ra) # 57aa <printint>
    5924:	8b4a                	mv	s6,s2
      state = 0;
    5926:	4981                	li	s3,0
    5928:	b771                	j	58b4 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    592a:	008b0913          	addi	s2,s6,8
    592e:	4681                	li	a3,0
    5930:	4629                	li	a2,10
    5932:	000b2583          	lw	a1,0(s6)
    5936:	8556                	mv	a0,s5
    5938:	00000097          	auipc	ra,0x0
    593c:	e72080e7          	jalr	-398(ra) # 57aa <printint>
    5940:	8b4a                	mv	s6,s2
      state = 0;
    5942:	4981                	li	s3,0
    5944:	bf85                	j	58b4 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    5946:	008b0913          	addi	s2,s6,8
    594a:	4681                	li	a3,0
    594c:	4641                	li	a2,16
    594e:	000b2583          	lw	a1,0(s6)
    5952:	8556                	mv	a0,s5
    5954:	00000097          	auipc	ra,0x0
    5958:	e56080e7          	jalr	-426(ra) # 57aa <printint>
    595c:	8b4a                	mv	s6,s2
      state = 0;
    595e:	4981                	li	s3,0
    5960:	bf91                	j	58b4 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5962:	008b0793          	addi	a5,s6,8
    5966:	f8f43423          	sd	a5,-120(s0)
    596a:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    596e:	03000593          	li	a1,48
    5972:	8556                	mv	a0,s5
    5974:	00000097          	auipc	ra,0x0
    5978:	e14080e7          	jalr	-492(ra) # 5788 <putc>
  putc(fd, 'x');
    597c:	85ea                	mv	a1,s10
    597e:	8556                	mv	a0,s5
    5980:	00000097          	auipc	ra,0x0
    5984:	e08080e7          	jalr	-504(ra) # 5788 <putc>
    5988:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    598a:	03c9d793          	srli	a5,s3,0x3c
    598e:	97de                	add	a5,a5,s7
    5990:	0007c583          	lbu	a1,0(a5)
    5994:	8556                	mv	a0,s5
    5996:	00000097          	auipc	ra,0x0
    599a:	df2080e7          	jalr	-526(ra) # 5788 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    599e:	0992                	slli	s3,s3,0x4
    59a0:	397d                	addiw	s2,s2,-1
    59a2:	fe0914e3          	bnez	s2,598a <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    59a6:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    59aa:	4981                	li	s3,0
    59ac:	b721                	j	58b4 <vprintf+0x60>
        s = va_arg(ap, char*);
    59ae:	008b0993          	addi	s3,s6,8
    59b2:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    59b6:	02090163          	beqz	s2,59d8 <vprintf+0x184>
        while(*s != 0){
    59ba:	00094583          	lbu	a1,0(s2)
    59be:	c9a1                	beqz	a1,5a0e <vprintf+0x1ba>
          putc(fd, *s);
    59c0:	8556                	mv	a0,s5
    59c2:	00000097          	auipc	ra,0x0
    59c6:	dc6080e7          	jalr	-570(ra) # 5788 <putc>
          s++;
    59ca:	0905                	addi	s2,s2,1
        while(*s != 0){
    59cc:	00094583          	lbu	a1,0(s2)
    59d0:	f9e5                	bnez	a1,59c0 <vprintf+0x16c>
        s = va_arg(ap, char*);
    59d2:	8b4e                	mv	s6,s3
      state = 0;
    59d4:	4981                	li	s3,0
    59d6:	bdf9                	j	58b4 <vprintf+0x60>
          s = "(null)";
    59d8:	00003917          	auipc	s2,0x3
    59dc:	9b090913          	addi	s2,s2,-1616 # 8388 <malloc+0x286a>
        while(*s != 0){
    59e0:	02800593          	li	a1,40
    59e4:	bff1                	j	59c0 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    59e6:	008b0913          	addi	s2,s6,8
    59ea:	000b4583          	lbu	a1,0(s6)
    59ee:	8556                	mv	a0,s5
    59f0:	00000097          	auipc	ra,0x0
    59f4:	d98080e7          	jalr	-616(ra) # 5788 <putc>
    59f8:	8b4a                	mv	s6,s2
      state = 0;
    59fa:	4981                	li	s3,0
    59fc:	bd65                	j	58b4 <vprintf+0x60>
        putc(fd, c);
    59fe:	85d2                	mv	a1,s4
    5a00:	8556                	mv	a0,s5
    5a02:	00000097          	auipc	ra,0x0
    5a06:	d86080e7          	jalr	-634(ra) # 5788 <putc>
      state = 0;
    5a0a:	4981                	li	s3,0
    5a0c:	b565                	j	58b4 <vprintf+0x60>
        s = va_arg(ap, char*);
    5a0e:	8b4e                	mv	s6,s3
      state = 0;
    5a10:	4981                	li	s3,0
    5a12:	b54d                	j	58b4 <vprintf+0x60>
    }
  }
}
    5a14:	70e6                	ld	ra,120(sp)
    5a16:	7446                	ld	s0,112(sp)
    5a18:	74a6                	ld	s1,104(sp)
    5a1a:	7906                	ld	s2,96(sp)
    5a1c:	69e6                	ld	s3,88(sp)
    5a1e:	6a46                	ld	s4,80(sp)
    5a20:	6aa6                	ld	s5,72(sp)
    5a22:	6b06                	ld	s6,64(sp)
    5a24:	7be2                	ld	s7,56(sp)
    5a26:	7c42                	ld	s8,48(sp)
    5a28:	7ca2                	ld	s9,40(sp)
    5a2a:	7d02                	ld	s10,32(sp)
    5a2c:	6de2                	ld	s11,24(sp)
    5a2e:	6109                	addi	sp,sp,128
    5a30:	8082                	ret

0000000000005a32 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5a32:	715d                	addi	sp,sp,-80
    5a34:	ec06                	sd	ra,24(sp)
    5a36:	e822                	sd	s0,16(sp)
    5a38:	1000                	addi	s0,sp,32
    5a3a:	e010                	sd	a2,0(s0)
    5a3c:	e414                	sd	a3,8(s0)
    5a3e:	e818                	sd	a4,16(s0)
    5a40:	ec1c                	sd	a5,24(s0)
    5a42:	03043023          	sd	a6,32(s0)
    5a46:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5a4a:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5a4e:	8622                	mv	a2,s0
    5a50:	00000097          	auipc	ra,0x0
    5a54:	e04080e7          	jalr	-508(ra) # 5854 <vprintf>
}
    5a58:	60e2                	ld	ra,24(sp)
    5a5a:	6442                	ld	s0,16(sp)
    5a5c:	6161                	addi	sp,sp,80
    5a5e:	8082                	ret

0000000000005a60 <printf>:

void
printf(const char *fmt, ...)
{
    5a60:	711d                	addi	sp,sp,-96
    5a62:	ec06                	sd	ra,24(sp)
    5a64:	e822                	sd	s0,16(sp)
    5a66:	1000                	addi	s0,sp,32
    5a68:	e40c                	sd	a1,8(s0)
    5a6a:	e810                	sd	a2,16(s0)
    5a6c:	ec14                	sd	a3,24(s0)
    5a6e:	f018                	sd	a4,32(s0)
    5a70:	f41c                	sd	a5,40(s0)
    5a72:	03043823          	sd	a6,48(s0)
    5a76:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5a7a:	00840613          	addi	a2,s0,8
    5a7e:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5a82:	85aa                	mv	a1,a0
    5a84:	4505                	li	a0,1
    5a86:	00000097          	auipc	ra,0x0
    5a8a:	dce080e7          	jalr	-562(ra) # 5854 <vprintf>
}
    5a8e:	60e2                	ld	ra,24(sp)
    5a90:	6442                	ld	s0,16(sp)
    5a92:	6125                	addi	sp,sp,96
    5a94:	8082                	ret

0000000000005a96 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5a96:	1141                	addi	sp,sp,-16
    5a98:	e422                	sd	s0,8(sp)
    5a9a:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5a9c:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5aa0:	00003797          	auipc	a5,0x3
    5aa4:	9187b783          	ld	a5,-1768(a5) # 83b8 <freep>
    5aa8:	a805                	j	5ad8 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5aaa:	4618                	lw	a4,8(a2)
    5aac:	9db9                	addw	a1,a1,a4
    5aae:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5ab2:	6398                	ld	a4,0(a5)
    5ab4:	6318                	ld	a4,0(a4)
    5ab6:	fee53823          	sd	a4,-16(a0)
    5aba:	a091                	j	5afe <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5abc:	ff852703          	lw	a4,-8(a0)
    5ac0:	9e39                	addw	a2,a2,a4
    5ac2:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5ac4:	ff053703          	ld	a4,-16(a0)
    5ac8:	e398                	sd	a4,0(a5)
    5aca:	a099                	j	5b10 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5acc:	6398                	ld	a4,0(a5)
    5ace:	00e7e463          	bltu	a5,a4,5ad6 <free+0x40>
    5ad2:	00e6ea63          	bltu	a3,a4,5ae6 <free+0x50>
{
    5ad6:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5ad8:	fed7fae3          	bgeu	a5,a3,5acc <free+0x36>
    5adc:	6398                	ld	a4,0(a5)
    5ade:	00e6e463          	bltu	a3,a4,5ae6 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5ae2:	fee7eae3          	bltu	a5,a4,5ad6 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5ae6:	ff852583          	lw	a1,-8(a0)
    5aea:	6390                	ld	a2,0(a5)
    5aec:	02059813          	slli	a6,a1,0x20
    5af0:	01c85713          	srli	a4,a6,0x1c
    5af4:	9736                	add	a4,a4,a3
    5af6:	fae60ae3          	beq	a2,a4,5aaa <free+0x14>
    bp->s.ptr = p->s.ptr;
    5afa:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5afe:	4790                	lw	a2,8(a5)
    5b00:	02061593          	slli	a1,a2,0x20
    5b04:	01c5d713          	srli	a4,a1,0x1c
    5b08:	973e                	add	a4,a4,a5
    5b0a:	fae689e3          	beq	a3,a4,5abc <free+0x26>
  } else
    p->s.ptr = bp;
    5b0e:	e394                	sd	a3,0(a5)
  freep = p;
    5b10:	00003717          	auipc	a4,0x3
    5b14:	8af73423          	sd	a5,-1880(a4) # 83b8 <freep>
}
    5b18:	6422                	ld	s0,8(sp)
    5b1a:	0141                	addi	sp,sp,16
    5b1c:	8082                	ret

0000000000005b1e <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5b1e:	7139                	addi	sp,sp,-64
    5b20:	fc06                	sd	ra,56(sp)
    5b22:	f822                	sd	s0,48(sp)
    5b24:	f426                	sd	s1,40(sp)
    5b26:	f04a                	sd	s2,32(sp)
    5b28:	ec4e                	sd	s3,24(sp)
    5b2a:	e852                	sd	s4,16(sp)
    5b2c:	e456                	sd	s5,8(sp)
    5b2e:	e05a                	sd	s6,0(sp)
    5b30:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5b32:	02051493          	slli	s1,a0,0x20
    5b36:	9081                	srli	s1,s1,0x20
    5b38:	04bd                	addi	s1,s1,15
    5b3a:	8091                	srli	s1,s1,0x4
    5b3c:	0014899b          	addiw	s3,s1,1
    5b40:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5b42:	00003517          	auipc	a0,0x3
    5b46:	87653503          	ld	a0,-1930(a0) # 83b8 <freep>
    5b4a:	c515                	beqz	a0,5b76 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5b4c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5b4e:	4798                	lw	a4,8(a5)
    5b50:	02977f63          	bgeu	a4,s1,5b8e <malloc+0x70>
    5b54:	8a4e                	mv	s4,s3
    5b56:	0009871b          	sext.w	a4,s3
    5b5a:	6685                	lui	a3,0x1
    5b5c:	00d77363          	bgeu	a4,a3,5b62 <malloc+0x44>
    5b60:	6a05                	lui	s4,0x1
    5b62:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5b66:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    5b6e:	84e90913          	addi	s2,s2,-1970 # 83b8 <freep>
  if(p == (char*)-1)
    5b72:	5afd                	li	s5,-1
    5b74:	a895                	j	5be8 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5b76:	00009797          	auipc	a5,0x9
    5b7a:	06278793          	addi	a5,a5,98 # ebd8 <base>
    5b7e:	00003717          	auipc	a4,0x3
    5b82:	82f73d23          	sd	a5,-1990(a4) # 83b8 <freep>
    5b86:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5b88:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5b8c:	b7e1                	j	5b54 <malloc+0x36>
      if(p->s.size == nunits)
    5b8e:	02e48c63          	beq	s1,a4,5bc6 <malloc+0xa8>
        p->s.size -= nunits;
    5b92:	4137073b          	subw	a4,a4,s3
    5b96:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5b98:	02071693          	slli	a3,a4,0x20
    5b9c:	01c6d713          	srli	a4,a3,0x1c
    5ba0:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5ba2:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5ba6:	00003717          	auipc	a4,0x3
    5baa:	80a73923          	sd	a0,-2030(a4) # 83b8 <freep>
      return (void*)(p + 1);
    5bae:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    5bb2:	70e2                	ld	ra,56(sp)
    5bb4:	7442                	ld	s0,48(sp)
    5bb6:	74a2                	ld	s1,40(sp)
    5bb8:	7902                	ld	s2,32(sp)
    5bba:	69e2                	ld	s3,24(sp)
    5bbc:	6a42                	ld	s4,16(sp)
    5bbe:	6aa2                	ld	s5,8(sp)
    5bc0:	6b02                	ld	s6,0(sp)
    5bc2:	6121                	addi	sp,sp,64
    5bc4:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5bc6:	6398                	ld	a4,0(a5)
    5bc8:	e118                	sd	a4,0(a0)
    5bca:	bff1                	j	5ba6 <malloc+0x88>
  hp->s.size = nu;
    5bcc:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5bd0:	0541                	addi	a0,a0,16
    5bd2:	00000097          	auipc	ra,0x0
    5bd6:	ec4080e7          	jalr	-316(ra) # 5a96 <free>
  return freep;
    5bda:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5bde:	d971                	beqz	a0,5bb2 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5be0:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5be2:	4798                	lw	a4,8(a5)
    5be4:	fa9775e3          	bgeu	a4,s1,5b8e <malloc+0x70>
    if(p == freep)
    5be8:	00093703          	ld	a4,0(s2)
    5bec:	853e                	mv	a0,a5
    5bee:	fef719e3          	bne	a4,a5,5be0 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    5bf2:	8552                	mv	a0,s4
    5bf4:	00000097          	auipc	ra,0x0
    5bf8:	b74080e7          	jalr	-1164(ra) # 5768 <sbrk>
  if(p == (char*)-1)
    5bfc:	fd5518e3          	bne	a0,s5,5bcc <malloc+0xae>
        return 0;
    5c00:	4501                	li	a0,0
    5c02:	bf45                	j	5bb2 <malloc+0x94>
