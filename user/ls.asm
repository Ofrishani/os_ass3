...
ls(char *path)
{
  ...
  dc:	9c050513          	addi	a0,a0,-1600 # a98 <malloc+0xea>
  e0:	00001097          	auipc	ra,0x1
  e4:	810080e7          	jalr	-2032(ra) # 8f0 <printf>
  char buf[512], *p;
  int fd;
  struct dirent de;
  struct stat st;
 ...
 13a:	9a250513          	addi	a0,a0,-1630 # ad8 <malloc+0x12a>
 13e:	00000097          	auipc	ra,0x0
 142:	7b2080e7          	jalr	1970(ra) # 8f0 <printf>
      }
 ...
 154:	9c050513          	addi	a0,a0,-1600 # b10 <malloc+0x162>
 158:	00000097          	auipc	ra,0x0
 15c:	798080e7          	jalr	1944(ra) # 8f0 <printf>
}
 ...
 188:	92458593          	addi	a1,a1,-1756 # aa8 <malloc+0xfa>
 18c:	4509                	li	a0,2
 18e:	00000097          	auipc	ra,0x0
 192:	734080e7          	jalr	1844(ra) # 8c2 <fprintf>
    return;
 196:	b7e9                	j	160 <ls+0xac>
    fprintf(2, "ls: cannot stat %s\n", path);
 198:	864a                	mv	a2,s2
 19a:	00001597          	auipc	a1,0x1
 19e:	92658593          	addi	a1,a1,-1754 # ac0 <malloc+0x112>
 1a2:	4509                	li	a0,2
 1a4:	00000097          	auipc	ra,0x0
 1a8:	71e080e7          	jalr	1822(ra) # 8c2 <fprintf>
    close(fd);
 1ac:	8526                	mv	a0,s1
 ...
 1d0:	91c50513          	addi	a0,a0,-1764 # ae8 <malloc+0x13a>
 1d4:	00000097          	auipc	ra,0x0
 1d8:	71c080e7          	jalr	1820(ra) # 8f0 <printf>
      break;
 ...
 216:	8eea0a13          	addi	s4,s4,-1810 # b00 <malloc+0x152>
        printf("ls: cannot stat %s\n", buf);
 21a:	00001a97          	auipc	s5,0x1
 21e:	8a6a8a93          	addi	s5,s5,-1882 # ac0 <malloc+0x112>
 ...
 22e:	6c6080e7          	jalr	1734(ra) # 8f0 <printf>
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 232:	4641                	li	a2,16
 ...
 296:	65e080e7          	jalr	1630(ra) # 8f0 <printf>
...
main(int argc, char *argv[])
{
 ...
 2b2:	87a50513          	addi	a0,a0,-1926 # b28 <malloc+0x17a>
 ...
 2f4:	84850513          	addi	a0,a0,-1976 # b38 <malloc+0x18a>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 660:	4ec50513          	addi	a0,a0,1260 # b48 <digits>
 664:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 72c:	420b8b93          	addi	s7,s7,1056 # b48 <digits>
 ...
 86c:	2d890913          	addi	s2,s2,728 # b40 <malloc+0x192>
        while(*s != 0){
...
free(void *ap)
{
 ...
 934:	2307b783          	ld	a5,560(a5) # b60 <freep>
 ...
 962:	00e6ea63          	bltu	a3,a4,976 <free+0x50>
{
 ...
 9a4:	1cf73023          	sd	a5,448(a4) # b60 <freep>
}
 9a8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9d6:	18e53503          	ld	a0,398(a0) # b60 <freep>
 ...
 9fe:	16690913          	addi	s2,s2,358 # b60 <freep>
  if(p == (char*)-1)
 a02:	5afd                	li	s5,-1
 a04:	a895                	j	a78 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 a06:	00000797          	auipc	a5,0x0
 a0a:	17278793          	addi	a5,a5,370 # b78 <base>
 a0e:	00000717          	auipc	a4,0x0
 a12:	14f73923          	sd	a5,338(a4) # b60 <freep>
 a16:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a3a:	12a73523          	sd	a0,298(a4) # b60 <freep>
      return (void*)(p + 1);
